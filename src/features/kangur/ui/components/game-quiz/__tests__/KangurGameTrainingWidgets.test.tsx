...
import { KangurGameCalendarTrainingWidget } from '../KangurGameCalendarTrainingWidget';
import { KangurGameGeometryTrainingWidget } from '../KangurGameGeometryTrainingWidget';
