...
/* eslint-disable complexity, max-lines, max-lines-per-function, no-nested-ternary, @typescript-eslint/explicit-function-return-type, @typescript-eslint/strict-boolean-expressions */
