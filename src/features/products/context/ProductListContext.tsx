...
const useProductListRowRuntimeStoreState = (
  ...
  const rowRuntimeStoreState = useMemo(
    () => ({
      ...
      scrapedSourceBadgeStatuses: badgeState.scrapedSourceBadgeStatuses,
      ecommerceBadgeIds: badgeState.ecommerceBadgeIds,
      ecommerceBadgeStatuses: badgeState.ecommerceBadgeStatuses,
    ...
    [
      ...
      badgeState.ecommerceBadgeIds,
      badgeState.ecommerceBadgeStatuses,
