import { Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Button } from '@/shared/ui/primitives.public';

export function SuggestionReviewRow({ suggestion, onSelect, onPromote, isReadOnly }: any) {
  return (
