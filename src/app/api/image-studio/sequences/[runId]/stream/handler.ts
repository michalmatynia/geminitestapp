...
export async function GET_handler(
  ...
  const initialRun = await getImageStudioSequenceRunById(runId);
  if (!initialRun) {
    ...
    async start(controller) {
      ...
      send({
        ...
        data: {
          ...
          currentSlotId: initialRun.currentSlotId,
          activeStepIndex: initialRun.activeStepIndex,
          activeStepId: initialRun.activeStepId,
          outputSlotCount: initialRun.outputSlotIds.length,
          outputSlotIds: initialRun.outputSlotIds,
          cancelRequested: initialRun.cancelRequested,
        },
      });
