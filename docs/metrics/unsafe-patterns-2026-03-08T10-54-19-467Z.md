...
Generated at: 2026-03-08T10:54:19.467Z
...
| ERROR | double-assertion | src/shared/lib/db/services/database-json-backup.ts:134 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/validation-pattern-repository/prisma-validation-pattern-repository.ts:176 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
