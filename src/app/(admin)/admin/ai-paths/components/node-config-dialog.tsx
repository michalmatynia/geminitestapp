...
export function NodeConfigDialog({
  ...
  React.useEffect(() => {
    ...
    const callbackValue = runtimeState.outputs[selectedNode.id]?.queryCallback;
                  ...
                  {selectedNode.type === "database" && selectedNode.config?.database && (
                    <Button
                      ...
                      onClick={() =>
                        updateSelectedNodeConfig({
                          database: {
                            ...selectedNode.config.database,
                            dryRun: !selectedNode.config.database.dryRun,
                          },
                        })
                      }
                    >
                ...
                <div className="space-y-4 rounded-md border border-gray-800 bg-gray-900/40 p-3">
                  ...
                  <div>
                    ...
                    {(() => {
                      ...
                      // Check for AI response in runtime state
                      const callbackValue = runtimeState.outputs[selectedNode.id]?.queryCallback;
                              ...
                              {hasAiResponse && (
                                <Button
                                  ...
                                  onClick={() => {
                                    updateQueryConfig({
                                      mode: "custom",
                                      queryTemplate: callbackValue as string,
                                    });
