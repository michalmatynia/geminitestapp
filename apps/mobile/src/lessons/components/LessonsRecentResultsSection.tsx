...
function RecentResultsContent({
  ...
  copy: LessonsRecentResultsSectionProps['copy'];
  lessonRecentResults: LessonsRecentResultsSectionProps['lessonRecentResults'];
}): React.JSX.Element {
  if (lessonRecentResults.isLoading || lessonRecentResults.isRestoringAuth) {
    return (
...
export function LessonsRecentResultsSection({
  ...
  return (
    <Card>
      ...
      <RecentResultsContent copy={copy} lessonRecentResults={lessonRecentResults} />
    </Card>
  );
}
