...
import type { AiPathsValidationModule, AiPathsValidationSeverity } from '@/shared/contracts/ai-paths';
import {
...
import { type AiPathsDocAssertion, type AiPathsDocsManifestSource, type CoverageMatrixDimensionValue } from './docs-registry-adapter.types';

export const hashText = (value: string): string =>
  createHash('sha256').update(value, 'utf8').digest('hex');

export const toModuleFromNodeType = (
  nodeType: string,
...
export const normalizeCoverageDimension = (
  value: string,
