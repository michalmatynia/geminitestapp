...
export function GuidedCalloutProvider({ children }: { children: React.ReactNode }) {
  ...
  }), [calloutLabelId, calloutDescriptionId, fallbackCopy, selectionState, selectionDisplayState, layoutState, sketchState, sectionLabel, homeOnboardingCanGoBack, usesDirectionalEntry]);
