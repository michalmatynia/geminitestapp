      ...
      <KangurAdminCard>
        <div className='flex items-center justify-between gap-3'>
          <div>
            ...
            <div className='text-sm text-muted-foreground'>Capability: Social Publishing Post Generation</div>
          </div>
      ...
      <KangurAdminCard>
        <div className='flex items-center justify-between gap-3'>
          <div>
            ...
            <div className='text-sm text-muted-foreground'>Capability: Social Publishing Visual Analysis</div>
          </div>
