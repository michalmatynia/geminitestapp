...
Generated at: 2026-04-14T12:38:11.946Z
...
| --- | --- | --- | ---: | ---: | --- |
| Authentication + Session Bootstrap | Successful sign-in completion rate | PASS | 5.9s | 0 | `__tests__/features/auth/pages/signin-page.test.tsx` |
...
| AI Paths Run Execution | Run completion without fallback/error path | FAIL | 4.3s | 1 | `__tests__/features/ai/ai-paths/services/path-run-executor.test.ts` |
