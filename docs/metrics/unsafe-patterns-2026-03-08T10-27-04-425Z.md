...
Generated at: 2026-03-08T10:27:04.425Z
...
| ERROR | double-assertion | src/features/cms/api/themes.ts:21 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/features/cms/api/themes.ts:37 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
...
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:87 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:97 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:149 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:179 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:191 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:198 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:207 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:217 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/read.ts:228 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/write.ts:50 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/write.ts:64 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/write.ts:135 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/write.ts:148 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/product-repository/mongo/write.ts:187 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/products/services/productService.ts:53 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
...
> Showing first 200 of 358 issues.
