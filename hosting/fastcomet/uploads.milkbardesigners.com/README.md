...
root for `uploads.milkbardesigners.com`.
...
with its own document root, for example
`/home/<account>/uploads.milkbardesigners.com`. Do not point the subdomain
document root at the nested `uploads` directory, because the app stores public
file paths with the `/uploads/...` prefix. After the DNS record exists, issue
AutoSSL/SSL for `uploads.milkbardesigners.com`.
...
MILKBAR_FASTCOMET_UPLOAD_URL=https://uploads.milkbardesigners.com/api/uploads/index.php
MILKBAR_FASTCOMET_DELETE_URL=https://uploads.milkbardesigners.com/api/uploads/delete/index.php
MILKBAR_FASTCOMET_SERVER=uploads.milkbardesigners.com
...
```sh
curl -i --resolve uploads.milkbardesigners.com:443:209.42.31.54 https://uploads.milkbardesigners.com/api/uploads/index.php
```
...
```text
hosting/fastcomet/uploads.milkbardesigners.com/public_html/uploads/cms/models/procedural/milkbar-hero-background.gltf
hosting/fastcomet/uploads.milkbardesigners.com/public_html/uploads/cms/models/procedural/milkbar-every-line-interior.gltf
hosting/fastcomet/uploads.milkbardesigners.com/public_html/uploads/cms/models/procedural/milkbar-project-mbd-001.gltf
hosting/fastcomet/uploads.milkbardesigners.com/public_html/uploads/cms/models/procedural/milkbar-project-mbd-002.gltf
hosting/fastcomet/uploads.milkbardesigners.com/public_html/uploads/cms/models/procedural/milkbar-project-mbd-003.gltf
```
