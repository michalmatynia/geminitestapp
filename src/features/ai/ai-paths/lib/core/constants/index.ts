...
export const NODE_TYPE_COMPATIBILITY: Record<NodeType, NodeType[]> = {
  ...
  database: ["viewer", "bundle", "template", "prompt", "mapper", "validator", "poll", "notification", "model", "agent"],
  db_schema: ["prompt", "template", "model", "agent", "bundle", "viewer", "database"],
  bundle: ["viewer", "template", "prompt", "poll", "database"],
  template: ["model", "agent", "viewer", "bundle", "prompt", "poll", "database"],
  prompt: ["model", "agent", "viewer", "bundle", "template", "poll", "notification"],
