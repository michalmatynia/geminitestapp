...
function NodeNameButton({ node, select }: { node: MasterTreeNode; select: () => void }): React.JSX.Element {
  return (
    <button
      type='button'
...
function SourceBadge({ label }: { label: BrainRoutingCapabilityNodeItemProps['sourceLabel'] }): React.JSX.Element {
  return (
    <Badge
      variant='outline'
