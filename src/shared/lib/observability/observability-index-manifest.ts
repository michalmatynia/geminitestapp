...
export const OBSERVABILITY_INDEX_MANIFEST: readonly ObservabilityIndexManifestEntry[] = [
  ...
  { collection: 'system_logs', key: { applicationId: 1, createdAt: -1 } },
  ...
  { collection: 'activity_logs', key: { applicationId: 1, createdAt: -1 } },
  ...
  { collection: 'error_logs', key: { createdAt: -1 } },
  { collection: 'error_logs', key: { applicationId: 1, createdAt: -1 } },
  { collection: 'error_logs', key: { applicationId: 1, originLogId: 1 } },
  { collection: 'error_logs', key: { source: 1, createdAt: -1 } },
  { collection: 'error_logs', key: { service: 1, createdAt: -1 } },
  { collection: 'error_logs', key: { requestId: 1 } },
  { collection: 'error_logs', key: { traceId: 1 } },
  { collection: 'error_logs', key: { correlationId: 1 } },
  {
