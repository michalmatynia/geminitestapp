...
import { POST as POST_BACKUP } from '@/features/database/server/api/backup/route-handler';
import { GET as GET_BACKUPS } from '@/features/database/server/api/backups/route-handler';
import { POST as POST_DELETE } from '@/features/database/server/api/delete/route-handler';
import { POST as POST_RESTORE } from '@/features/database/server/api/restore/route-handler';
import { POST as POST_UPLOAD } from '@/features/database/server/api/upload/route-handler';
