...
> = {
  ...
  pl: {
    ...
    textOverrides: {
      ...
      subtitle: 'Opcjonalne nadpisania kolorow tekstu strony, kart i nawigacji.',
    },
    logoLoader: {
      title: 'Logo i loader',
      subtitle: 'Dostroj gradienty logo Kangur uzywane w loaderze i nawigacji.',
    },
    layoutRadii: {
      title: 'Uklad i promienie',
      subtitle: 'Odstepy strony, zaokraglenia rogow i ustawienie paneli.',
    },
    gradientsTransparency: {
      title: 'Gradienty i przezroczystosc',
      subtitle: 'Dostroj tla paneli i przezroczystosc nawigacji.',
    },
    typography: {
      title: 'Typografia',
      subtitle: 'Fonty uzywane w naglowkach i tekscie glownym.',
    },
    buttonsGlobal: {
      title: 'Przyciski (globalnie)',
      subtitle: 'Wspolne ustawienia dla glownych i drugorzednych przyciskow.',
    },
    buttonShadows: {
      title: 'Cienie przyciskow',
      subtitle: 'Cienie zewnetrzne dla glownych i drugorzednych przyciskow.',
    },
    gelGlassEffects: {
      title: 'Efekty zelowe i szklane',
      subtitle: 'Ustawienia nowoczesnych efektow glass i gel.',
    },
    homeActionButtons: {
      title: 'Przyciski akcji strony glownej',
      subtitle: 'Specjalne nadpisania dla glownych kart akcji na stronie gry.',
    },
    dropShadows: {
      title: 'Cienie',
      subtitle: 'Wspolne konfiguracje cieni dla kontenerow i kart.',
    },
  },
};
...
const PAGE_COPY = {
  ...
  pl: {
    breadcrumbs: ['Admin', 'Kangur', 'Ustawienia', 'Wyglad'],
    shellTitle: 'Wyglad Kangur',
    shellDescription: 'Skupiony panel edycji dla lekcji, testow i operacji na tresci.',
    backToSettings: 'Wroc do ustawien',
    ...
    presetReadOnly:
      'To preset Crystal. Jest tylko do odczytu, ale nadal mozesz przypisac go do slotu powyzej.',
...
const MODE_SELECTOR_COPY = {
  ...
  pl: {
    ...
    description:
      'Wybierz, ktory system wizualny (jasny lub ciemny) ma byc ladowany domyslnie przy starcie aplikacji.',
    selectAriaLabel: 'Wybierz startowy tryb wygladu',
  },
} as const;
...
const IMPORT_EXPORT_COPY = {
  ...
  pl: {
    ...
    description: 'Przenos konfiguracje motywu miedzy srodowiskami za pomoca schowka.',
    exportButton: 'Eksportuj do schowka',
    importButton: 'Importuj ze schowka',
    exportError: 'Nie udalo sie skopiowac konfiguracji.',
    exportSuccess: 'Konfiguracja motywu skopiowana do schowka.',
    importError: 'Nieprawidlowy format danych w schowku.',
    importSuccess: 'Motyw wczytany ze schowka. Pamietaj o zapisaniu zmian.',
  },
} as const;
...
const THEME_CATALOG_COPY = {
  ...
  pl: {
    openButton: (count: number) => `Katalog motywow (${count})`,
    modalTitle: 'Katalog zapisanych motywow',
    ...
    sortAria: 'Sortowanie katalogu motywow',
    countSummary: (visible: number, total: number) => `Pokazano ${visible} z ${total} motywow`,
    defaultSortHint: 'Domyslnie: najnowsze motywy na gorze',
    savedBadge: 'Zapisany',
    createdLabel: 'Utworzono',
    updatedLabel: 'Zaktualizowano',
    selected: 'Wybrany',
    load: 'Wczytaj',
    duplicating: 'Duplikuje...',
    duplicate: 'Duplikuj',
    deleteAria: 'Usun motyw z katalogu',
    emptyCatalog: 'Brak zapisanych motywow w katalogu.',
    emptyFilters: 'Brak motywow pasujacych do biezacych filtrow.',
    noDate: 'brak daty',
    createDefaultName: 'Nowy motyw',
    duplicateSuffix: 'kopia',
    createError: 'Blad zapisu motywu.',
    createSuccess: 'Nowy motyw zostal dodany do katalogu.',
    duplicateError: 'Nie udalo sie zduplikowac motywu.',
    duplicateSuccess: 'Motyw zostal zduplikowany.',
    deleteError: 'Blad usuwania motywu.',
    deleteSuccess: 'Motyw zostal usuniety.',
    confirmDelete: 'Czy na pewno chcesz usunac ten motyw z katalogu?',
    sortOptions: [
...
const PREVIEW_COPY = {
  ...
  pl: {
    ...
    pageSubtext: 'Litery, sylaby i pierwsze slowa.',
    buttonLabels: {
      primary: 'Glowny',
      hover: 'Hover',
    ...
    lessonTitle: 'Lekcja 3 - Ulamki',
    lessonMeta: '12 cwiczen · 45 min',
    continueLabel: 'Kontynuuj',
    resultsLabel: 'Wyniki',
    searchPlaceholder: 'Wyszukaj cwiczenie...',
    studentOneName: 'Anna Kowalska',
    studentOneMeta: 'Postep: 74% · #12 w klasie',
    studentTwoName: 'Jan Nowak',
    studentTwoMeta: '1 240 pkt',
    profileLabel: 'Profil',
    dropdownItems: ['Ulamki zwykle', 'Ulamki dziesietne', 'Procenty'],
    accentGradientsLabel: 'Gradienty akcentow',
    accentGradientNames: ['Indygo', 'Fiolet', 'Szmaragd', 'Blekit', 'Bursztyn', 'Roz', 'Turkus', 'Lupkowy'],
    logoPaletteLabel: 'Paleta logo',
    logoPaletteNames: ['Napis start', 'Napis srodek', 'Napis koniec', 'Obwodka start', 'Obwodka koniec', 'Akcent start', 'Akcent koniec'],
    badgesLabel: 'Znaczniki',
    badges: ['Nowe', '-20%', 'Gotowe', 'Wazne', 'Info', 'VIP'],
    assistantName: 'Asystent AI',
    assistantStatus: 'online',
    assistantGreeting: 'Czesc! W czym moge Ci dzisiaj pomoc?',
    assistantHint: 'Podpowiedz: zapytaj o ulamki',
    userPrompt: 'Wyjasnij mi ulamki dziesietne',
    successMessage: 'Odpowiedz wygenerowana pomyslnie',
    chatChips: ['Wiecej', 'Quiz'],
    composerPlaceholder: 'Napisz wiadomosc...',
    elevatedLabel: 'Wyniesiony',
    subtleLabel: 'Subtelny',
    segmentedLabels: ['Dzien', 'Tydzien', 'Miesiac'],
    disabledFieldLabel: 'Pole wylaczone',
    controlLabel: 'Kontrolka',
    previewInputAria: 'pole podgladu',
  },
} as const;
...
const CONTEXT_COPY = {
  ...
  pl: {
    defaultModeSaveError: 'Nie udalo sie zapisac domyslnego motywu startowego.',
    defaultModeSaveSuccess: 'Domyslny motyw startowy zaktualizowany.',
    unsavedSwitchConfirm:
      'Masz niezapisane zmiany w aktualnym motywie. Czy na pewno chcesz przelaczyc?',
    assignError: 'Nie udalo sie przypisac motywu.',
    assignSuccess: (slotLabel: string) => `Motyw przypisany do slotu "${slotLabel}".`,
    unassignError: 'Nie udalo sie odpiac motywu.',
    unassignSuccess: (slotLabel: string) => `Slot "${slotLabel}" przywrocony do fabrycznego.`,
    saveFactoryError: 'Nie mozna zapisac zmian w motywie fabrycznym.',
    saveError: 'Blad zapisu motywu.',
    saveSuccess: 'Motyw zostal zapisany.',
  },
} as const;
