...
const MONGO_ENV_KEYS = [
  ...
  'STUDIQ_MONGODB_URI',
  'STUDIQ_MONGODB_DB',
  'STUDIQ_MONGODB_LOCAL_URI',
  'STUDIQ_MONGODB_LOCAL_DB',
  'STUDIQ_MONGODB_CLOUD_URI',
  'STUDIQ_MONGODB_CLOUD_DB',
  'CMS_BUILDER_MONGODB_URI',
  'CMS_BUILDER_MONGODB_DB',
  'CMS_BUILDER_MONGODB_LOCAL_URI',
  'CMS_BUILDER_MONGODB_LOCAL_DB',
  'CMS_BUILDER_MONGODB_CLOUD_URI',
  'CMS_BUILDER_MONGODB_CLOUD_DB',
] as const;
