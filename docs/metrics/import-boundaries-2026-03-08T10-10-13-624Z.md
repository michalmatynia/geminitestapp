...
Generated at: 2026-03-08T10:10:13.624Z
...
| --- | --- | ---: |
| ai | admin, auth, files, foldertree, jobs, notesapp, playwright, products, prompt-engine, prompt-exploder, tooltip-engine, viewer3d | 12 |
...
| --- | --- | --- | --- |
| ERROR | circular-feature-dep | - | Circular dependency between features: admin -> notesapp -> admin |
...
| ERROR | circular-feature-dep | - | Circular dependency between features: admin -> products -> ai -> admin |
| ERROR | circular-feature-dep | - | Circular dependency between features: admin -> products -> admin |
