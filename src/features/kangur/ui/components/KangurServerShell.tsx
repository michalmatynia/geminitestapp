      ...
      <div className='absolute inset-0 z-10 flex items-center justify-center'>
        <div className='relative flex h-full w-full items-center justify-center'>
          <div
            ...
            style={{
              background:
                'radial-gradient(circle, color-mix(in srgb, #cbd5e1 34%, transparent) 0%, transparent 74%)',
            }}
          />
          <div
            ...
            style={{
              background:
                'linear-gradient(180deg, color-mix(in srgb, #ffffff 88%, transparent) 0%, color-mix(in srgb, #ffffff 82%, #f8fafc) 100%)',
              borderColor: 'rgba(255,255,255,0.78)',
              boxShadow: '0 32px 84px -42px rgba(68,87,215,0.28)',
          ...
          >
            ...
            <div
              ...
              style={{ borderColor: 'color-mix(in srgb, #e2e8f0 56%, transparent)' }}
            />
            <div
              className='relative flex h-24 w-24 items-center justify-center rounded-full border'
              style={{
                background:
                  'radial-gradient(circle at 32% 28%, color-mix(in srgb, #ffffff 96%, white), color-mix(in srgb, #ffffff 88%, #eef2ff) 58%, color-mix(in srgb, #ffffff 80%, #e2e8f0) 100%)',
                borderColor: 'color-mix(in srgb, #e2e8f0 58%, transparent)',
                boxShadow:
            ...
            >
              <div
                ...
                style={{ borderColor: 'color-mix(in srgb, #e2e8f0 48%, transparent)' }}
              />
