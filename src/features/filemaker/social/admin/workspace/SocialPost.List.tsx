...
import {
  useSocialPublishingPostsPage,
  type SocialPublishingPostListStatus,
} from '@/features/filemaker/social/hooks/useSocialPublishingPosts';

const PAGE_SIZE = 8;

const STATUS_FILTER_OPTIONS: Array<{ value: SocialPublishingPostListStatus; label: string }> = [
...
const resolveSocialPostListStatus = (post: SocialPublishingPost): SocialPublishingPost['status'] =>
              ...
              onValueChange={(value: string) =>
                setStatusFilter(
                  STATUS_FILTER_OPTIONS.some((option) => option.value === value)
                    ? (value as SocialPublishingPostListStatus)
                    : 'all'
                )
              }
        ...
        <>
          ...
          return (
            ...
            >
              ...
              {(() => {
                const isPublished = hasPublication;
                ...
                const postId = post.publishedPostId ?? '—';
                const postUrl = post.publishedUrl ?? null;
                    ...
                    <DropdownMenuContent align='end' className='w-72'>
                      ...
                      <DropdownMenuItem
                        ...
                        disabled={
                          unpublishPending ||
                          hasBlockingRuntimeJob ||
                          !hasSocialPublishingPublicationTarget(post)
                        }
              ...
              {!hasPublication && post.status === 'draft' && (
