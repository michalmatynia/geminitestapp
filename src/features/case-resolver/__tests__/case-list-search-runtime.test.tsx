...
const buildWorkspace = (): CaseResolverWorkspace => ({
  files: [
    ...
    },
    {
      ...
      folder: 'evidence',
      scanSlots: [{ id: 'slot-1', fileId: 'file-beta-1', status: 'completed', progress: 100, ocrText: 'invoice scan text' }],
    },
  ],
...
describe('CaseListSearchPanel shared runtime search', () => {
  it('keeps grouped summary, case ordering, expand/collapse, and callbacks parity', () => {
    ...
    expect(onPrefetchFile).toHaveBeenCalledWith(
      expect.objectContaining({ id: 'file-beta-1' })
    );
