...
Generated at: 2026-03-08T12:14:01.010Z
...
| WARN | context-oversized | src/features/ai/ai-paths/context/GraphContext.tsx | Context file is 667 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/ai/image-studio/context/SlotsContext.tsx | Context file is 568 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/cms/components/page-builder/context/ComponentSettingsContext.tsx | Context file is 517 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/cms/components/page-builder/theme/ThemeColorsContext.tsx | Context file is 516 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/files/contexts/FileManagerContext.tsx | Context file is 513 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/products/components/ProductImageManagerUIContext.tsx | Context file is 527 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
...
| WARN | context-oversized | src/features/products/context/ProductStudioContext.tsx | Context file is 540 lines (threshold: 500). Consider extracting logic into hooks or splitting the context. |
