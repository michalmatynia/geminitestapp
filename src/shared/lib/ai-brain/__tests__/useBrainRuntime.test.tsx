...
import { useBrainRuntime } from '@/shared/lib/ai-brain/context/useBrainRuntime';
...
vi.mock('@/shared/lib/ai-brain/context/useBrainDerivedState', () => ({
  useBrainDerivedState: vi.fn(),
}));

vi.mock('@/shared/lib/ai-brain/context/useBrainPersistence', () => ({
