...
vi.mock('@/features/ai/ai-paths/components/context/AdminAiPathsValidationContext', () => ({
  useAdminAiPathsValidationContext:
    validationRulesEditorMocks.useAdminAiPathsValidationContextMock as typeof import('@/features/ai/ai-paths/components/context/AdminAiPathsValidationContext').useAdminAiPathsValidationContext,
}));
