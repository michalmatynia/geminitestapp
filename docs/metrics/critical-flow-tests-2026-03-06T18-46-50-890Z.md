...
Generated at: 2026-03-06T18:46:50.890Z
...
| --- | --- | --- | ---: | ---: | --- |
| Authentication + Session Bootstrap | Successful sign-in completion rate | PASS | 4.8s | 0 | `__tests__/features/auth/pages/signin-page.test.tsx` |
...
| AI Paths Run Execution | Run completion without fallback/error path | FAIL | 4.8s | 1 | `__tests__/features/ai/ai-paths/services/path-run-executor.test.ts` |
| Case Resolver OCR + Capture Mapping | Queue-to-review completion without manual recovery | FAIL | 885ms | 1 | `src/features/case-resolver/__tests__/workspace-persistence.test.ts` |
