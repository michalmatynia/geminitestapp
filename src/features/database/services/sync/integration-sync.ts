...
export const syncIntegrationConnections: SyncHandler = async ({ mongo, prisma, normalizeId, toDate }) => {
...
export const syncProductListings: SyncHandler = async ({ mongo, prisma, normalizeId, toDate, toJsonValue }) => {
