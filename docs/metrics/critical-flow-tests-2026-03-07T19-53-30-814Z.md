...
Generated at: 2026-03-07T19:53:30.814Z
...
| --- | --- | --- | ---: | ---: | --- |
| Authentication + Session Bootstrap | Successful sign-in completion rate | PASS | 4.9s | 0 | `__tests__/features/auth/pages/signin-page.test.tsx` |
...
| Case Resolver OCR + Capture Mapping | Queue-to-review completion without manual recovery | PASS | 2.2s | 0 | `src/features/case-resolver/__tests__/workspace-persistence.test.ts` |
