...
import { AdminBrainPage } from '@/shared/lib/ai-brain/pages/AdminBrainPage';
...
vi.mock('@/shared/lib/ai-brain/components/BrainSettingsHeader', () => ({
  BrainSettingsHeader: () => <div>BrainSettingsHeader</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/BrainStateOverview', () => ({
  BrainStateOverview: () => <div>BrainStateOverview</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/OperationsTab', () => ({
  OperationsTab: () => <div>OperationsTab</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/RoutingTab', () => ({
  RoutingTab: () => <div>RoutingTab</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/ProvidersTab', () => ({
  ProvidersTab: () => <div>ProvidersTab</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/ReportsTab', () => ({
  ReportsTab: () => <div>ReportsTab</div>,
}));

vi.mock('@/shared/lib/ai-brain/components/MetricsTab', () => ({
