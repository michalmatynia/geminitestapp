...
import type { ThemeSettings } from '@/shared/contracts/cms/theme-settings';
import {
  SettingsField,
...
export function ThemeButtonsSection(): React.JSX.Element {
  ...
  const fields: SettingsField<ThemeSettings>[] = [
    ...
    { key: 'btnBorderWidth', label: 'Border Thickness', type: 'number', min: 0, max: 8, suffix: 'px' },
    { key: 'btnBorderOpacity', label: 'Border Opacity', type: 'range', min: 0, max: 100, suffix: '%' },
    { key: 'btnBorderRadius', label: 'Border Corner radius', type: 'number', min: 0, max: 48, suffix: 'px' },
    
    { key: 'btnShadowOpacity', label: 'Shadow Opacity', type: 'range', min: 0, max: 100, suffix: '%' },
    { key: 'btnShadowX', label: 'Shadow Horizontal', type: 'number', min: -20, max: 20, suffix: 'px' },
    { key: 'btnShadowY', label: 'Shadow Vertical', type: 'number', min: -20, max: 20, suffix: 'px' },
