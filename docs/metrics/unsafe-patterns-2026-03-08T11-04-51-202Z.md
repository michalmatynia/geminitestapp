...
Generated at: 2026-03-08T11:04:51.202Z
...
| Metric | Count |
| --- | ---: |
| doubleAssertionCount | 3 |
| anyCount | 38 |
| eslintDisableCount | 63 |
...
| @typescript-eslint/no-unsafe-assignment | 11 |
...
| --- | ---: | ---: | ---: |
| double-assertion | 3 | 0 | 0 |
| eslint-disable | 0 | 0 | 63 |
| explicit-any | 0 | 0 | 38 |
...
| --- | --- | --- | --- |
| ERROR | double-assertion | src/features/ai/insights/generator/settings-service.ts:17 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/ai-paths/portable-engine/sinks-settings-store.server.ts:12 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
| ERROR | double-assertion | src/shared/lib/ai-paths/portable-engine/sinks-settings-store.server.ts:29 | Unsafe double type assertion (as unknown as). Use a type guard or proper narrowing instead. |
