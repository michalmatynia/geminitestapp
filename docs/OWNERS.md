...
1. Every docs page should include `owner` and `last_reviewed` metadata.
2. Incident-impacting changes require runbook updates before closure.
3. Missing owner metadata is treated as documentation debt and should be fixed in the same PR.
