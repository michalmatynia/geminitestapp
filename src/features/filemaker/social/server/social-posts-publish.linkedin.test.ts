...
describe('publishLinkedInPersonalPost', () => {
  ...
  it('publishes a post using the selected Publishing connection', async () => {
    mocks.listIntegrationsMock.mockResolvedValue([
      {
        id: 'int-1',
        slug: 'linkedin',
    ...
    const post: SocialPublishingPost = {
      ...basePost,
...
describe('deleteLinkedInPersonalPost', () => {
  ...
  it('deletes a LinkedIn post when only the published URL is stored locally', async () => {
    mocks.listIntegrationsMock.mockResolvedValue([
      {
        id: 'int-1',
        slug: 'linkedin',
