...
import { useFolderTreeKeyboardNav } from '@/shared/lib/foldertree/v2/hooks/useFolderTreeKeyboardNav';
...
} from '@/shared/lib/foldertree/v2/shell/useFolderTreeShellRuntime';
