...
function EmptyFocusState({ copy }: { copy: DailyPlanFocusSectionProps['copy'] }): React.JSX.Element {
  return (
    <Card>
...
function FocusContent({
  ...
  weakestFocus: DailyPlanFocusSectionProps['weakestFocus'];
  strongestFocus: DailyPlanFocusSectionProps['strongestFocus'];
  copy: DailyPlanFocusSectionProps['copy'];
}): React.JSX.Element {
  return (
    <Card>
...
export function DailyPlanFocusSection({
  ...
  if (weakestFocus === null && strongestFocus === null) {
    return <EmptyFocusState copy={copy} />;
  }

  return <FocusContent copy={copy} weakestFocus={weakestFocus} strongestFocus={strongestFocus} />;
}
