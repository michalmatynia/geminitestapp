...
export const kangurTextFieldVariants = cva(
  'kangur-text-field soft-card w-full border outline-none transition disabled:cursor-not-allowed disabled:opacity-70',
  {
    variants: {
      accent: {
        indigo: buildTextFieldAccentClassName('indigo'),
        violet: buildTextFieldAccentClassName('violet'),
        emerald: buildTextFieldAccentClassName('emerald'),
        sky: buildTextFieldAccentClassName('sky'),
        amber: buildTextFieldAccentClassName('amber'),
        rose: buildTextFieldAccentClassName('rose'),
        teal: buildTextFieldAccentClassName('teal'),
        slate: buildTextFieldAccentClassName('slate'),
      },
      size: {
        sm: 'px-3 py-2.5',
        md: 'px-4 py-3',
