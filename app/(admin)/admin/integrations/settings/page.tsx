    ...
    <div className="container mx-auto py-10">
      <div className="rounded-lg bg-gray-950 p-6 shadow-lg">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">Integrations Settings</h1>
            <p className="mt-1 text-sm text-gray-400">
              Control where integrations data is stored.
            </p>
          </div>
          <Link
        ...
        <div className="rounded-lg border border-gray-800 bg-gray-900/60 p-5">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">
                Changes apply to integrations and their connections.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-4 max-w-md">
            ...
            <select
              ...
              className="mt-2 w-full rounded-md border border-gray-800 bg-gray-950 px-3 py-2 text-sm text-white disabled:cursor-not-allowed disabled:text-gray-500"
            >
