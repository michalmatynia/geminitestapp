...
import type { ImageStudioPromptExtractMode, ImageStudioPromptExtractResponse, ImageStudioPromptExtractSource } from '@/shared/contracts/image-studio/image-studio/misc';
