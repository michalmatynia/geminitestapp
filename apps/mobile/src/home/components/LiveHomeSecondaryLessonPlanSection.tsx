...
function LessonPlanChips({
  copy,
  lessonMastery,
}: {
  copy: ReturnType<typeof useKangurMobileI18n>['copy'];
  lessonMastery: ReturnType<typeof useKangurMobileHomeLessonMastery>;
}): React.JSX.Element {
  return (
...
export function LiveHomeSecondaryLessonPlanSection(): React.JSX.Element {
  ...
  return (
    <>
      <LessonPlanChips copy={copy} lessonMastery={lessonMastery} />
      {lessonMastery.trackedLessons === 0 ? (
        ...
        <LessonPlanCards copy={copy} lessonMastery={lessonMastery} />
      )}
    </>
  );
}
