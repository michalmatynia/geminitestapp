...
export function AdminImageStudioSettingsPage(
  ...
  return (
    <AdminImageStudioSettingsView
      ...
      resetStudioSettings={resetStudioSettings}
      saveStudioSettings={saveStudioSettings}
      updateSetting={updateSetting}
      advancedOverridesError={advancedOverridesError}
      promptValidationRulesError={promptValidationRulesError}
      settingsSource={settingsSource}
      studioSettings={studioSettings}
      setStudioSettings={setStudioSettings}
      toggleProjectSequencingOperation={toggleProjectSequencingOperation}
      moveProjectSequencingOperation={moveProjectSequencingOperation}
      selectedGenerationModel={selectedGenerationModel}
      setGenerationModelAndPresets={setGenerationModelAndPresets}
      quickSwitchModels={quickSwitchModels}
      quickSwitchModelSelectOptions={quickSwitchModelSelectOptions}
      ...
      setImageStudioApiKey={setImageStudioApiKey}
      modelCapabilities={modelCapabilities}
      modelAwareSizeValue={modelAwareSizeValue}
      modelAwareQualityValue={modelAwareQualityValue}
      modelAwareBackgroundValue={modelAwareBackgroundValue}
      modelAwareFormatValue={modelAwareFormatValue}
      modelAwareSizeOptions={modelAwareSizeOptions}
      modelAwareQualityOptions={modelAwareQualityOptions}
      modelAwareBackgroundOptions={modelAwareBackgroundOptions}
      modelAwareFormatOptions={modelAwareFormatOptions}
      advancedOverridesText={advancedOverridesText}
      handleAdvancedOverridesChange={handleAdvancedOverridesChange}
      promptValidationEnabled={promptValidationEnabled}
      setPromptValidationEnabled={setPromptValidationEnabled}
      promptValidationRulesText={promptValidationRulesText}
      handlePromptValidationRulesChange={handlePromptValidationRulesChange}
      backfillProjectId={backfillProjectId}
      setBackfillProjectId={setBackfillProjectId}
      backfillDryRun={backfillDryRun}
      setBackfillDryRun={setBackfillDryRun}
      backfillIncludeHeuristicGenerationLinks={backfillIncludeHeuristicGenerationLinks}
      setBackfillIncludeHeuristicGenerationLinks={setBackfillIncludeHeuristicGenerationLinks}
      runCardBackfill={runCardBackfill}
      backfillRunning={backfillRunning}
      backfillResultText={backfillResultText}
    />
  );
}
