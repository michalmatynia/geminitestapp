...
Generated at: 2026-03-04T00:58:45.590Z

## Snapshot

- Source files: 4172
- Source lines: 646678
- use client files: 1280
- Files >= 1000 LOC: 7
- Files >= 1500 LOC: 1
- Largest file: `src/features/case-resolver/__tests__/workspace.test.ts` (1790 LOC)
- API routes: 318
...
| File | LOC |
| --- | ---: |
| `src/features/case-resolver/__tests__/workspace.test.ts` | 1790 |
| `src/features/filemaker/__tests__/settings.test.ts` | 1205 |
...
| `src/shared/contracts/prompt-exploder.ts` | 1143 |
| `src/shared/contracts/cms.ts` | 1010 |
| `src/shared/lib/ai-paths/core/validation-engine/docs-registry-adapter.loaders.ts` | 984 |
...
| `src/shared/lib/ai-paths/hooks/useAiPathTriggerEvent.ts` | 895 |
