...
Generated at: 2026-04-12T13:29:36.611Z
...
| --- | --- | --- | ---: | ---: | --- |
| Authentication + Session Bootstrap | Successful sign-in completion rate | PASS | 3.9s | 0 | `__tests__/features/auth/pages/signin-page.test.tsx` |
...
| AI Paths Run Execution | Run completion without fallback/error path | PASS | 4.5s | 0 | `__tests__/features/ai/ai-paths/services/path-run-executor.test.ts` |
