...
export function PreviewHeroSection(): React.JSX.Element {
  try {
    ...
    logClientCatch(internalError('Failed to render PreviewHeroSection'), {
      source: 'cms.preview-sections',
      action: 'renderHeroSection',
...
export function PreviewImageWithTextSection(): React.JSX.Element {
  try {
    ...
    logClientCatch(internalError('Failed to render PreviewImageWithTextSection'), {
      source: 'cms.preview-sections',
      action: 'renderImageWithTextSection',
      cause: error instanceof Error ? error.message : String(error),
    });
    return <></>;
  }
...
export function PreviewRichTextSection(): React.JSX.Element {
  try {
    ...
    logClientCatch(internalError('Failed to render PreviewRichTextSection'), {
      source: 'cms.preview-sections',
      action: 'renderRichTextSection',
      cause: error instanceof Error ? error.message : String(error),
    });
    return <></>;
  }
