...
const useVintedQuickListClickHandler = (
  ...
  const quickListMutation = createMutationV2<void, void>({
    ...
    meta: {
      source: 'products.quickList.VintedQuickListButton.run',
      operation: 'action',
      resource: 'products.quick-list.vinted',
      domain: 'products',
      description: 'Runs the Vinted one-click product listing flow.',
      errorPresentation: 'toast',
      tags: ['products', 'vinted', 'quick-list'],
    },
  });
