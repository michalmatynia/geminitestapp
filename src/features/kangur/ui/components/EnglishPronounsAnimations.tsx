...
export function EnglishPronounsPulseAnimation(): React.JSX.Element {
  ...
  return (
    <svg
      aria-label='Animated pronoun chat. Pronoun tags float gently around a message bubble.'
    ...
    >
      ...
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .bubble-glow, .chip-a, .chip-b, .chip-c, .chip-d, .ring, .spark { animation: none; }
          .ring { opacity: 0.25; }
      ...
      <text className='sub' x='180' y='88' textAnchor='middle'>Tap / Click</text>
