...
Generated at: 2026-03-08T13:20:50.815Z
...
| /admin | admin | PASS | 2.8s | 0 |
| /admin/products | admin | PASS | 2.5s | 0 |
| /admin/notes | admin | PASS | 2.7s | 0 |
| /admin/integrations | admin | PASS | 2.8s | 0 |
| /admin/case-resolver | admin | PASS | 5.0s | 0 |
| /admin/cms | admin | PASS | 3.1s | 0 |
| /admin/ai-paths | admin | PASS | 3.9s | 0 |
| /admin/image-studio | admin | PASS | 3.7s | 0 |
| /admin/chatbot | admin | PASS | 3.0s | 0 |
| /admin/agentcreator | admin | PASS | 3.3s | 0 |
| /admin/prompt-engine/validation | admin | PASS | 4.4s | 0 |
| /admin/kangur | admin | PASS | 3.8s | 0 |
| /admin/databases/engine | admin | PASS | 2.7s | 0 |
| /admin/brain?tab=routing | admin | PASS | 2.8s | 0 |
