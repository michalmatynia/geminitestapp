...
export function useEnglishAdverbsFrequencyRoutineGameState() {
  ...
  const round = ENGLISH_ADVERBS_FREQUENCY_ROUTINE_ROUNDS[roundIndex] ?? ENGLISH_ADVERBS_FREQUENCY_ROUTINE_ROUNDS[0];
