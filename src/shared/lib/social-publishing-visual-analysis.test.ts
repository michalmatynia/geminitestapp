...
import {
  normalizeSocialPublishingVisualAnalysis,
  sanitizeSocialPublishingVisualHighlights,
  sanitizeSocialPublishingVisualSummary,
} from './social-publishing-visual-analysis';

describe('kangur social visual analysis normalization', () => {
  it('strips non-visual narrative sections from legacy summaries', () => {
    expect(
      sanitizeSocialPublishingVisualSummary(`Okay, I've reviewed the provided text and images. Here's a summary of the key information. The screenshots show a Polish-localized navigation, updated lesson labels, and refreshed card styling across the app.
