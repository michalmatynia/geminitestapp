...
const KANGUR_DUELS_CREATE_ENDPOINT = '/api/kangur/duels/create';
const KANGUR_DUELS_JOIN_ENDPOINT = '/api/kangur/duels/join';
const KANGUR_DUELS_STATE_ENDPOINT = '/api/kangur/duels/state';
const KANGUR_DUELS_LOBBY_ENDPOINT = '/api/kangur/duels/lobby';
const KANGUR_DUELS_OPPONENTS_ENDPOINT = '/api/kangur/duels/opponents';
const KANGUR_DUELS_SEARCH_ENDPOINT = '/api/kangur/duels/search';
const KANGUR_DUELS_ANSWER_ENDPOINT = '/api/kangur/duels/answer';
const KANGUR_DUELS_LEAVE_ENDPOINT = '/api/kangur/duels/leave';
...
const requestDuelStateFromApi = async (
  sessionId: string,
...
const requestDuelLobbyFromApi = async (
...
const requestDuelOpponentsFromApi = async (
  options?: { limit?: number; signal?: AbortSignal }
...
const requestDuelSearchFromApi = async (
  query: string,
  options?: { limit?: number; signal?: AbortSignal }
...
const createDuelViaApi = async (input: KangurDuelCreateInput): Promise<KangurDuelStateResponse> => {
  try {
...
const joinDuelViaApi = async (input: KangurDuelJoinInput): Promise<KangurDuelStateResponse> => {
  try {
...
const submitDuelAnswerViaApi = async (
...
const leaveDuelViaApi = async (input: KangurDuelLeaveInput): Promise<KangurDuelStateResponse> => {
  try {
...
export const createLocalKangurPlatform = (): KangurPlatform => {
  return {
    ...
    duels: {
      create: async (input: KangurDuelCreateInput) => createDuelViaApi(input),
      join: async (input: KangurDuelJoinInput) => joinDuelViaApi(input),
      state: async (sessionId: string, options?: { signal?: AbortSignal }) =>
        requestDuelStateFromApi(sessionId, options),
      lobby: async (options?: { limit?: number; signal?: AbortSignal }) =>
        requestDuelLobbyFromApi(options),
      recentOpponents: async (options?: { limit?: number; signal?: AbortSignal }) =>
        requestDuelOpponentsFromApi(options),
      search: async (query: string, options?: { limit?: number; signal?: AbortSignal }) =>
        requestDuelSearchFromApi(query, options),
      answer: async (input: KangurDuelAnswerInput) => submitDuelAnswerViaApi(input),
      leave: async (input: KangurDuelLeaveInput) => leaveDuelViaApi(input),
    },
  };
};
