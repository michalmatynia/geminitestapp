...
export const TEN_YEAR_OLD_ENGLISH_GAMES: readonly KangurGameDefinition[] = [
  ...
  createSharedLibraryGame({
    id: 'english_going_to_plan_parade',
    engineId: 'sentence-builder-engine',
    subject: 'english',
    ageGroup: 'ten_year_old',
    lessonComponentIds: ['english_going_to'],
    label: 'English going to plan parade',
    title: 'English Going To Plan Parade',
    description:
      'Shared future-plans engine for building going-to sentences across lesson and fullscreen flows.',
    emoji: '🧳',
    mechanic: 'sentence_building',
    interactionMode: 'tap',
    tags: ['english', 'grammar', 'future', 'going-to'],
    sortOrder: 1215,
    launchableRuntimeId: 'english_going_to_quiz',
    lessonVariantSurface: 'lesson_stage',
  }),
  createSharedLibraryGame({
