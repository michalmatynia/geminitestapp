...
describe('AiPathsLiveLog', () => {
  ...
  it('renders the newest 80 events in reverse order with badge fallbacks', () => {
    ...
    mockState.runtimeEvents = runtimeEvents;
