...
export type KangurResolvedLessonGroupAccordionProps = {
  accordionId: string;
  label: ReactNode;
  typeLabel?: ReactNode;
...
export function KangurResolvedLessonGroupAccordion({
  accordionId,
  label,
  ...
  className,
  contentProps,
}: KangurResolvedLessonGroupAccordionProps): React.JSX.Element {
