...
vi.mock('@/features/kangur/social/server/social-posts-pipeline', () => ({
  runKangurSocialPostPipeline: (...args: unknown[]) =>
    runKangurSocialPostPipelineMock(...args),
}));

vi.mock('@/features/kangur/social/server/social-posts-runtime', () => ({
...
vi.mock('@/features/kangur/social/settings', () => ({
