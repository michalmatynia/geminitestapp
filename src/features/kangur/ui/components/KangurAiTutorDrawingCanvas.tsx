...
export function KangurAiTutorDrawingCanvas({ onComplete, onCancel }: Props): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-wrap items-center gap-2 border-t border-amber-100/60 px-3 py-2'>
      ...
      <div className='flex justify-end gap-2 border-t border-amber-100/60 px-3 py-2'>
        <KangurButton
          type='button'
          size='sm'
          variant='surface'
