...
- `compatibility` (compatibility/parity strategy backed by the legacy handler registry; retained for historical telemetry and non-canonical fallback semantics)
