...
export function SocialPostEditorModal({
  ...
  const hasPublication = hasSocialPublishingPublication(activePost);
  ...
  const modalActions = activePost ? (
    <>
      ...
      <Button
        ...
        disabled={!activePost || isSubmitting || hasBlockingRuntimeJob || hasPublication}
        title={editorActionTitle}
      >
        {publishActionLabel || 'Publish now'}
      </Button>
    </>
  ) : null;
              ...
              <FormSection title='Scheduling' className='space-y-3'>
                <div className='flex flex-wrap items-center gap-2'>
                  ...
                  <Input
                    ...
                    value={scheduledAt}
                    disabled={hasBlockingRuntimeJob || hasPublication}
