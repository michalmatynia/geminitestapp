...
export const NODE_TYPE_COMPATIBILITY: Record<NodeType, NodeType[]> = {
  ...
  database: ["viewer", "bundle", "template", "prompt", "mapper", "validator", "iterator", "poll", "notification", "model", "agent"],
  db_schema: ["prompt", "template", "model", "agent", "bundle", "viewer", "database"],
  bundle: ["viewer", "template", "prompt", "poll", "database"],
  template: ["model", "agent", "viewer", "bundle", "prompt", "poll", "database", "iterator"],
  prompt: ["model", "agent", "viewer", "bundle", "template", "poll", "notification", "iterator"],
  model: ["prompt", "database", "viewer", "description_updater", "bundle", "poll", "notification", "agent", "iterator"],
