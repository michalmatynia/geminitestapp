...
async function GET_handler(_req: NextRequest, params: { id: string }) {
...
async function PATCH_handler(req: NextRequest, params: { id: string }) {
...
async function DELETE_handler(_req: NextRequest, params: { id: string }) {
