...
export function KangurHomeLogo({
  ...
  const ringMaskId = `${iconId}-ring-mask`;
  ...
  return (
    ...
    >
      <defs>
        ...
        <mask id={ringMaskId}>
          <circle cx='648' cy='116' r='64' fill='white' />
          <circle cx='648' cy='116' r='38' fill='black' />
        </mask>
      ...
      <g filter={`url(#${shadowId})`}>
        <path
          ...
          fill={`url(#${wordGradId})`}
        />
        <circle cx='648' cy='116' fill={`url(#${ringGradId})`} mask={`url(#${ringMaskId})`} r='64' />
        <path
          d='M690,160 l26,24'
