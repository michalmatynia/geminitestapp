  ...
  const handleSave = useCallback(async (): Promise<void> => {
    ...
    if (isCreateMode) {
      ...
      const newOrganization = createFilemakerOrganization({
        ...
        jobBoardCompanyLogoUrl: orgDraft.jobBoardCompanyLogoUrl ?? '',
        jobBoardCompanyPhone: orgDraft.jobBoardCompanyPhone ?? '',
        jobBoardCompanyProfile: orgDraft.jobBoardCompanyProfile ?? '',
        jobBoardCompanyProfileScrapedAt: orgDraft.jobBoardCompanyProfileScrapedAt ?? '',
        jobBoardCompanyProfileUrl: orgDraft.jobBoardCompanyProfileUrl ?? '',
        jobBoardCompanyRegion: orgDraft.jobBoardCompanyRegion ?? '',
        jobBoardCompanySize: orgDraft.jobBoardCompanySize ?? '',
        jobBoardCompanyWebsiteUrl: orgDraft.jobBoardCompanyWebsiteUrl ?? '',
        jobBoardScrapedAt: orgDraft.jobBoardScrapedAt ?? '',
        jobBoardSourceLabel: orgDraft.jobBoardSourceLabel ?? '',
        jobBoardSourceSite: orgDraft.jobBoardSourceSite ?? '',
        jobBoardSourceUrl: orgDraft.jobBoardSourceUrl ?? '',
        createdAt: now,
        updatedAt: now,
      });
      nextDatabase = {
