...
export const AI_PATHS_TOOLTIP_CATALOG: AiPathsTooltipDocEntry[] = [
  {
    ...
    aliases: ['clear connector data'],
    docPath: '/docs/ai-paths/node-validator-runtime-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'runtime', 'connector'],
    uiTargets: ['canvas.header.clear-connector-data'],
  },
  {
    ...
    docPath: '/docs/ai-paths/node-validator-runtime-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'runtime', 'history'],
    uiTargets: ['canvas.header.clear-history'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['enable validation', 'node validation'],
    docPath: '/docs/ai-paths/node-validator-central-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'validation'],
    uiTargets: ['canvas.header.enable-node-validation'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['show canvas only', 'show side panels', 'focus mode'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'canvas', 'layout'],
    uiTargets: ['canvas.header.focus-mode-toggle'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['node validator'],
    docPath: '/docs/ai-paths/node-validator-central-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'validation', 'patterns'],
    uiTargets: ['canvas.header.node-validator'],
  },
  {
    ...
    tags: ['ai-paths', 'manual', 'controls', 'path'],
    uiTargets: ['canvas.header.path-name'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['path selector'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'path'],
    uiTargets: ['canvas.header.path-selector'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['paths settings'],
    docPath: '/docs/ai-paths/node-validator-central-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'settings'],
    uiTargets: ['canvas.header.paths-settings'],
  },
  {
    id: 'canvas_save_path',
    title: 'Save Path',
    ...
    aliases: ['save path'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'canvas', 'save'],
    uiTargets: ['canvas.header.save-path'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['activate path', 'deactivate path'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'runtime'],
    uiTargets: ['canvas.header.path-active'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['lock path', 'unlock path'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'path'],
    uiTargets: ['canvas.header.path-lock'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['validate nodes'],
    docPath: '/docs/ai-paths/node-validator-central-patterns.md',
    tags: ['ai-paths', 'manual', 'controls', 'validation'],
    uiTargets: ['canvas.header.validate-nodes'],
  },
  {
    id: 'docs_snippet_docs_description_snippet',
    title: 'Docs Description Snippet',
    summary:
      'Snippet source for docs panel content. First line: ContextFilter.entityJson -> Parser.entityJson',
    ...
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'docs', 'snippets', 'docs-snippet'],
    uiTargets: ['docs.snippet.docs_description_snippet'],
  },
  {
    ...
    section: 'Docs Snippets',
    aliases: ['DOCS_JOBS_SNIPPET', 'docs snippet', '# Inline (Model waits for result)'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'docs', 'snippets', 'docs-snippet'],
    uiTargets: ['docs.snippet.docs_jobs_snippet'],
  },
  {
    id: 'docs_snippet_docs_overview_snippet',
    title: 'Docs Overview Snippet',
    summary:
      'Snippet source for docs panel content. First line: AI Paths is a node-and-wire runtime that turns a graph into a reproducible workflow.',
    section: 'Docs Snippets',
    aliases: [
    ...
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'docs', 'snippets', 'docs-snippet'],
    uiTargets: ['docs.snippet.docs_overview_snippet'],
  },
  {
    id: 'docs_snippet_docs_wiring_snippet',
    title: 'Docs Wiring Snippet',
    summary:
      'Snippet source for docs panel content. First line: Trigger.trigger -> Simulation.trigger',
    section: 'Docs Snippets',
    aliases: ['DOCS_WIRING_SNIPPET', 'docs snippet', 'Trigger.trigger -> Simulation.trigger'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'docs', 'snippets', 'docs-snippet'],
    uiTargets: ['docs.snippet.docs_wiring_snippet'],
  },
  {
    ...
    section: 'Canvas Header',
    aliases: ['docs tooltip', 'tooltips'],
    docPath: '/docs/ai-paths/tooltip-schema-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'tooltips'],
    uiTargets: ['canvas.header.docs-tooltips-toggle'],
  },
  {
    ...
    section: 'Inspector',
    aliases: ['node description'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'inspector'],
    uiTargets: ['inspector.node-description'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'inspector'],
    uiTargets: ['inspector.node-title'],
  },
  {
    ...
    section: 'Inspector',
    aliases: ['open node config'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'inspector', 'node-config'],
    uiTargets: ['inspector.open-node-config'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'inspector'],
    uiTargets: ['inspector.remove-node'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['agent', 'Reasoning Agent', 'agent config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.agent'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['ai_description', 'AI Description Generator', 'ai_description config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.ai_description'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['api_advanced', 'API Operation (Advanced)', 'api_advanced config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.api_advanced'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['audio_oscillator', 'Audio Oscillator', 'audio_oscillator config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.audio_oscillator'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['audio_speaker', 'Audio Speaker (Mono)', 'audio_speaker config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.audio_speaker'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['bundle', 'Bundle', 'bundle config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.bundle'],
  },
  {
    ...
    aliases: ['close node config'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'node-config'],
    uiTargets: ['node-config.close'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['compare', 'Compare', 'compare config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.compare'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['constant', 'Constant', 'constant config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.constant'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['context', 'Context Filter', 'context config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.context'],
  },
  {
    ...
    section: 'Node Config Modal',
    aliases: ['copy node id'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'node-config'],
    uiTargets: ['node-config.copy-id'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['database', 'Database Query', 'database config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.database'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['db_schema', 'Database Schema', 'db_schema config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.db_schema'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['delay', 'Delay', 'delay config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.delay'],
  },
  {
    ...
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.description_updater'],
  },
  {
    ...
    aliases: ['agent', 'agent.personaId', 'agent.agent.personaId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.agent.agent.personaId'],
  },
  {
    ...
    section: 'Node Config - Reasoning Agent',
    aliases: ['agent', 'agent.promptTemplate', 'agent.agent.promptTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.agent.agent.promptTemplate'],
  },
  {
    ...
    section: 'Node Config - Reasoning Agent',
    aliases: ['agent', 'agent.waitForResult', 'agent.agent.waitForResult'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.agent.agent.waitForResult'],
  },
  {
    ...
    section: 'Node Config - Reasoning Agent',
    aliases: ['agent', 'runtime.cache.mode', 'agent.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.agent.runtime.cache.mode'],
  },
  {
    ...
    section: 'Node Config - Reasoning Agent',
    aliases: ['agent', 'runtime.waitForInputs', 'agent.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.agent.runtime.waitForInputs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.ai_description.description.generationOutputEnabled'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.ai_description.description.visionOutputEnabled'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - AI Description Generator',
    aliases: ['ai_description', 'runtime.cache.mode', 'ai_description.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.ai_description.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - AI Description Generator',
    aliases: ['ai_description', 'runtime.waitForInputs', 'ai_description.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.ai_description.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['api_advanced', 'apiAdvanced.authMode', 'api_advanced.apiAdvanced.authMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.authMode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.errorRoutesJson'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.headersJson', 'api_advanced.apiAdvanced.headersJson'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.headersJson'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.method', 'api_advanced.apiAdvanced.method'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.method'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.outputMappingsJson'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.paginationMode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.pathParamsJson'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.queryParamsJson'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.responseMode', 'api_advanced.apiAdvanced.responseMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.responseMode'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.responsePath', 'api_advanced.apiAdvanced.responsePath'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.responsePath'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.retryAttempts'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.retryEnabled', 'api_advanced.apiAdvanced.retryEnabled'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.retryEnabled'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.retryOnStatusJson'],
  },
  {
    ...
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'apiAdvanced.url', 'api_advanced.apiAdvanced.url'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.apiAdvanced.url'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'runtime.cache.mode', 'api_advanced.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - API Operation (Advanced)',
    aliases: ['api_advanced', 'runtime.waitForInputs', 'api_advanced.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.api_advanced.runtime.waitForInputs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.audioOscillator.durationMs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.audioOscillator.frequencyHz'],
  },
  {
    ...
    section: 'Node Config - Audio Oscillator',
    aliases: ['audio_oscillator', 'audioOscillator.gain', 'audio_oscillator.audioOscillator.gain'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.audioOscillator.gain'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.audioOscillator.waveform'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Audio Oscillator',
    aliases: ['audio_oscillator', 'runtime.cache.mode', 'audio_oscillator.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.runtime.cache.mode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_oscillator.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['audio_speaker', 'audioSpeaker.autoPlay', 'audio_speaker.audioSpeaker.autoPlay'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.audioSpeaker.autoPlay'],
  },
  {
    ...
    section: 'Node Config - Audio Speaker (Mono)',
    aliases: ['audio_speaker', 'audioSpeaker.enabled', 'audio_speaker.audioSpeaker.enabled'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.audioSpeaker.enabled'],
  },
  {
    ...
    section: 'Node Config - Audio Speaker (Mono)',
    aliases: ['audio_speaker', 'audioSpeaker.gain', 'audio_speaker.audioSpeaker.gain'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.audioSpeaker.gain'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.audioSpeaker.stopPrevious'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Audio Speaker (Mono)',
    aliases: ['audio_speaker', 'runtime.cache.mode', 'audio_speaker.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Audio Speaker (Mono)',
    aliases: ['audio_speaker', 'runtime.waitForInputs', 'audio_speaker.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.audio_speaker.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['bundle', 'bundle.includePorts', 'bundle.bundle.includePorts'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.bundle.bundle.includePorts'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Bundle',
    aliases: ['bundle', 'runtime.cache.mode', 'bundle.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.bundle.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Bundle',
    aliases: ['bundle', 'runtime.waitForInputs', 'bundle.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.bundle.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['compare', 'compare.caseSensitive', 'compare.compare.caseSensitive'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.compare.caseSensitive'],
  },
  {
    ...
    section: 'Node Config - Compare',
    aliases: ['compare', 'compare.compareTo', 'compare.compare.compareTo'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.compare.compareTo'],
  },
  {
    ...
    section: 'Node Config - Compare',
    aliases: ['compare', 'compare.message', 'compare.compare.message'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.compare.message'],
  },
  {
    ...
    section: 'Node Config - Compare',
    aliases: ['compare', 'compare.operator', 'compare.compare.operator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.compare.operator'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Compare',
    aliases: ['compare', 'runtime.cache.mode', 'compare.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Compare',
    aliases: ['compare', 'runtime.waitForInputs', 'compare.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.compare.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['constant', 'constant.value', 'constant.constant.value'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.constant.constant.value'],
  },
  {
    ...
    section: 'Node Config - Constant',
    aliases: ['constant', 'constant.valueType', 'constant.constant.valueType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.constant.constant.valueType'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Constant',
    aliases: ['constant', 'runtime.cache.mode', 'constant.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.constant.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Constant',
    aliases: ['constant', 'runtime.waitForInputs', 'constant.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.constant.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['context', 'context.entityId', 'context.context.entityId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.entityId'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.entityIdSource', 'context.context.entityIdSource'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.entityIdSource'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.entityType', 'context.context.entityType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.entityType'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.excludePaths', 'context.context.excludePaths'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.excludePaths'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.includePaths', 'context.context.includePaths'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.includePaths'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.role', 'context.context.role'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.role'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.scopeMode', 'context.context.scopeMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.scopeMode'],
  },
  {
    ...
    section: 'Node Config - Context Filter',
    aliases: ['context', 'context.scopeTarget', 'context.context.scopeTarget'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.context.scopeTarget'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Context Filter',
    aliases: ['context', 'runtime.cache.mode', 'context.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Context Filter',
    aliases: ['context', 'runtime.waitForInputs', 'context.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.context.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['database', 'database.action', 'database.database.action'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.action'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.actionCategory', 'database.database.actionCategory'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.actionCategory'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.aiPrompt', 'database.database.aiPrompt'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.aiPrompt'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.distinctField', 'database.database.distinctField'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.distinctField'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.dryRun', 'database.database.dryRun'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.dryRun'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.entityType', 'database.database.entityType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.entityType'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.idField', 'database.database.idField'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.idField'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.mappings', 'database.database.mappings'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.mappings'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.mode', 'database.database.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.mode'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.operation', 'database.database.operation'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.operation'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.allowUnknownParameterIds'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.definitionsPath'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.definitionsPort'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.enabled'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.enforceOptionLabels'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.parameterInferenceGuard.targetPath'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query', 'database.database.query'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.collection', 'database.database.query.collection'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.collection'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.field', 'database.database.query.field'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.field'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.idType', 'database.database.query.idType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.idType'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.limit', 'database.database.query.limit'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.limit'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.mode', 'database.database.query.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.mode'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.preset', 'database.database.query.preset'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.preset'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.projection', 'database.database.query.projection'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.projection'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.provider', 'database.database.query.provider'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.provider'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.queryTemplate', 'database.database.query.queryTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.queryTemplate'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.single', 'database.database.query.single'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.single'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.query.sort', 'database.database.query.sort'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.query.sort'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.skipEmpty', 'database.database.skipEmpty'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.skipEmpty'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.trimStrings', 'database.database.trimStrings'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.trimStrings'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.updateStrategy', 'database.database.updateStrategy'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.updateStrategy'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.updateTemplate', 'database.database.updateTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.updateTemplate'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.useMongoActions', 'database.database.useMongoActions'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.useMongoActions'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.writeSource', 'database.database.writeSource'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.writeSource'],
  },
  {
    ...
    section: 'Node Config - Database Query',
    aliases: ['database', 'database.writeSourcePath', 'database.database.writeSourcePath'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.database.writeSourcePath'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Database Query',
    aliases: ['database', 'runtime.cache.mode', 'database.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Database Query',
    aliases: ['database', 'runtime.waitForInputs', 'database.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.database.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['db_schema', 'db_schema.collections', 'db_schema.db_schema.collections'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.collections'],
  },
  {
    ...
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'db_schema.formatAs', 'db_schema.db_schema.formatAs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.formatAs'],
  },
  {
    ...
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'db_schema.includeFields', 'db_schema.db_schema.includeFields'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.includeFields'],
  },
  {
    ...
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'db_schema.includeRelations', 'db_schema.db_schema.includeRelations'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.includeRelations'],
  },
  {
    ...
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'db_schema.mode', 'db_schema.db_schema.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.mode'],
  },
  {
    ...
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'db_schema.provider', 'db_schema.db_schema.provider'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.db_schema.provider'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'runtime.cache.mode', 'db_schema.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Database Schema',
    aliases: ['db_schema', 'runtime.waitForInputs', 'db_schema.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.db_schema.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['delay', 'delay.ms', 'delay.delay.ms'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.delay.delay.ms'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Delay',
    aliases: ['delay', 'runtime.cache.mode', 'delay.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.delay.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Delay',
    aliases: ['delay', 'runtime.waitForInputs', 'delay.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.delay.runtime.waitForInputs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/description_updater.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.description_updater.runtime.cache.mode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/description_updater.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.description_updater.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['gate', 'gate.failMessage', 'gate.gate.failMessage'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.gate.gate.failMessage'],
  },
  {
    ...
    section: 'Node Config - Gate',
    aliases: ['gate', 'gate.mode', 'gate.gate.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.gate.gate.mode'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Gate',
    aliases: ['gate', 'runtime.cache.mode', 'gate.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.gate.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Gate',
    aliases: ['gate', 'runtime.waitForInputs', 'gate.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.gate.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['http', 'http.bodyTemplate', 'http.http.bodyTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.bodyTemplate'],
  },
  {
    ...
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'http.headers', 'http.http.headers'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.headers'],
  },
  {
    ...
    summary: 'HTTP method.',
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'http.method', 'http.http.method'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.method'],
  },
  {
    ...
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'http.responseMode', 'http.http.responseMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.responseMode'],
  },
  {
    ...
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'http.responsePath', 'http.http.responsePath'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.responsePath'],
  },
  {
    ...
    summary: 'Request URL.',
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'http.url', 'http.http.url'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.http.url'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'runtime.cache.mode', 'http.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - HTTP Fetch',
    aliases: ['http', 'runtime.waitForInputs', 'http.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.http.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['iterator', 'iterator.autoContinue', 'iterator.iterator.autoContinue'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.iterator.iterator.autoContinue'],
  },
  {
    ...
    section: 'Node Config - Iterator',
    aliases: ['iterator', 'iterator.maxSteps', 'iterator.iterator.maxSteps'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.iterator.iterator.maxSteps'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Iterator',
    aliases: ['iterator', 'runtime.cache.mode', 'iterator.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.iterator.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Iterator',
    aliases: ['iterator', 'runtime.waitForInputs', 'iterator.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.iterator.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['learner_agent', 'learnerAgent.agentId', 'learner_agent.learnerAgent.agentId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.learner_agent.learnerAgent.agentId'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.learner_agent.learnerAgent.includeSources'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.learner_agent.learnerAgent.promptTemplate'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Learner Agent',
    aliases: ['learner_agent', 'runtime.cache.mode', 'learner_agent.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.learner_agent.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Learner Agent',
    aliases: ['learner_agent', 'runtime.waitForInputs', 'learner_agent.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.learner_agent.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['mapper', 'mapper.mappings', 'mapper.mapper.mappings'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mapper.mapper.mappings'],
  },
  {
    ...
    section: 'Node Config - JSON Mapper',
    aliases: ['mapper', 'mapper.outputs', 'mapper.mapper.outputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mapper.mapper.outputs'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - JSON Mapper',
    aliases: ['mapper', 'runtime.cache.mode', 'mapper.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mapper.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - JSON Mapper',
    aliases: ['mapper', 'runtime.waitForInputs', 'mapper.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mapper.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['math', 'math.operand', 'math.math.operand'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.math.math.operand'],
  },
  {
    ...
    section: 'Node Config - Math',
    aliases: ['math', 'math.operation', 'math.math.operation'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.math.math.operation'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Math',
    aliases: ['math', 'runtime.cache.mode', 'math.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.math.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Math',
    aliases: ['math', 'runtime.waitForInputs', 'math.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.math.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['model', 'model.maxTokens', 'model.model.maxTokens'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.model.maxTokens'],
  },
  {
    ...
    section: 'Node Config - Model',
    aliases: ['model', 'model.modelId', 'model.model.modelId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.model.modelId'],
  },
  {
    ...
    section: 'Node Config - Model',
    aliases: ['model', 'model.temperature', 'model.model.temperature'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.model.temperature'],
  },
  {
    ...
    section: 'Node Config - Model',
    aliases: ['model', 'model.vision', 'model.model.vision'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.model.vision'],
  },
  {
    ...
    section: 'Node Config - Model',
    aliases: ['model', 'model.waitForResult', 'model.model.waitForResult'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.model.waitForResult'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Model',
    aliases: ['model', 'runtime.cache.mode', 'model.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Model',
    aliases: ['model', 'runtime.waitForInputs', 'model.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.model.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['mutator', 'mutator.path', 'mutator.mutator.path'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mutator.mutator.path'],
  },
  {
    ...
    section: 'Node Config - Mutator',
    aliases: ['mutator', 'mutator.valueTemplate', 'mutator.mutator.valueTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mutator.mutator.valueTemplate'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Mutator',
    aliases: ['mutator', 'runtime.cache.mode', 'mutator.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mutator.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Mutator',
    aliases: ['mutator', 'runtime.waitForInputs', 'mutator.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.mutator.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['notification', 'runtime.cache.mode', 'notification.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/notification.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.notification.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Toast Notification',
    aliases: ['notification', 'runtime.waitForInputs', 'notification.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/notification.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.notification.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['parser', 'parser.mappings', 'parser.parser.mappings'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.parser.parser.mappings'],
  },
  {
    ...
    section: 'Node Config - JSON Parser',
    aliases: ['parser', 'parser.outputMode', 'parser.parser.outputMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.parser.parser.outputMode'],
  },
  {
    ...
    section: 'Node Config - JSON Parser',
    aliases: ['parser', 'parser.presetId', 'parser.parser.presetId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.parser.parser.presetId'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - JSON Parser',
    aliases: ['parser', 'runtime.cache.mode', 'parser.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.parser.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - JSON Parser',
    aliases: ['parser', 'runtime.waitForInputs', 'parser.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.parser.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['playwright', 'playwright.browserEngine', 'playwright.playwright.browserEngine'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.browserEngine'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.capture.html', 'playwright.playwright.capture.html'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.capture.html'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.capture.screenshot'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.capture.trace', 'playwright.playwright.capture.trace'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.capture.trace'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.capture.video', 'playwright.playwright.capture.video'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.capture.video'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.contextOptionsJson'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.launchOptionsJson'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.personaId', 'playwright.playwright.personaId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.personaId'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.script', 'playwright.playwright.script'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.script'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.settingsOverrides'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.startUrlTemplate'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.timeoutMs', 'playwright.playwright.timeoutMs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.timeoutMs'],
  },
  {
    ...
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'playwright.waitForResult', 'playwright.playwright.waitForResult'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.playwright.waitForResult'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'runtime.cache.mode', 'playwright.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Playwright',
    aliases: ['playwright', 'runtime.waitForInputs', 'playwright.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.playwright.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['poll', 'poll.dbQuery', 'poll.poll.dbQuery'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery'],
  },
  {
    ...
    summary: 'Collection to query (example: products).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.collection', 'poll.poll.dbQuery.collection'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.collection'],
  },
  {
    ...
    summary: 'Field used by preset queries (example: _id, productId).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.field', 'poll.poll.dbQuery.field'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.field'],
  },
  {
    ...
    summary: 'How to treat IDs: string vs objectId.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.idType', 'poll.poll.dbQuery.idType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.idType'],
  },
  {
    ...
    summary: 'Limit for multi-result queries.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.limit', 'poll.poll.dbQuery.limit'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.limit'],
  },
  {
    ...
    summary: 'preset uses a predefined query; custom uses queryTemplate.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.mode', 'poll.poll.dbQuery.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.mode'],
  },
  {
    ...
    summary: 'Preset query shape (by_id/by_productId/by_entityId/by_field).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.preset', 'poll.poll.dbQuery.preset'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.preset'],
  },
  {
    ...
    summary: 'Projection JSON (string).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.projection', 'poll.poll.dbQuery.projection'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.projection'],
  },
  {
    ...
    summary: 'Database provider (mongodb|prisma).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.provider', 'poll.poll.dbQuery.provider'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.provider'],
  },
  {
    ...
    summary: 'JSON query template (string) with {{placeholders}}.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.queryTemplate', 'poll.poll.dbQuery.queryTemplate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.queryTemplate'],
  },
  {
    ...
    summary: 'If true, treat result as a single document.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.single', 'poll.poll.dbQuery.single'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.single'],
  },
  {
    ...
    summary: 'Sort JSON (string).',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.dbQuery.sort', 'poll.poll.dbQuery.sort'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.dbQuery.sort'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.intervalMs', 'poll.poll.intervalMs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.intervalMs'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.maxAttempts', 'poll.poll.maxAttempts'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.maxAttempts'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.mode', 'poll.poll.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.mode'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.resultPath', 'poll.poll.resultPath'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.resultPath'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.successOperator', 'poll.poll.successOperator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.successOperator'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.successPath', 'poll.poll.successPath'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.successPath'],
  },
  {
    ...
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'poll.successValue', 'poll.poll.successValue'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.poll.successValue'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'runtime.cache.mode', 'poll.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Poll Job',
    aliases: ['poll', 'runtime.waitForInputs', 'poll.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.poll.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['prompt', 'prompt.template', 'prompt.prompt.template'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.prompt.prompt.template'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Prompt',
    aliases: ['prompt', 'runtime.cache.mode', 'prompt.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.prompt.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Prompt',
    aliases: ['prompt', 'runtime.waitForInputs', 'prompt.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.prompt.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['regex', 'regex.aiPrompt', 'regex.regex.aiPrompt'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.aiPrompt'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.flags', 'regex.regex.flags'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.flags'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.groupBy', 'regex.regex.groupBy'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.groupBy'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.includeUnmatched', 'regex.regex.includeUnmatched'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.includeUnmatched'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.matchMode', 'regex.regex.matchMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.matchMode'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.mode', 'regex.regex.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.mode'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.outputMode', 'regex.regex.outputMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.outputMode'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.pattern', 'regex.regex.pattern'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.pattern'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.sampleText', 'regex.regex.sampleText'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.sampleText'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.splitLines', 'regex.regex.splitLines'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.splitLines'],
  },
  {
    ...
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'regex.unmatchedKey', 'regex.regex.unmatchedKey'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.regex.unmatchedKey'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'runtime.cache.mode', 'regex.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Regex Grouper',
    aliases: ['regex', 'runtime.waitForInputs', 'regex.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.regex.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['router', 'router.compareTo', 'router.router.compareTo'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.router.router.compareTo'],
  },
  {
    ...
    section: 'Node Config - Router',
    aliases: ['router', 'router.matchMode', 'router.router.matchMode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.router.router.matchMode'],
  },
  {
    ...
    section: 'Node Config - Router',
    aliases: ['router', 'router.mode', 'router.router.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.router.router.mode'],
  },
  {
    ...
    summary:
      'Node output caching. auto = reuse when safe, force = always reuse, disabled = recompute each run.',
    section: 'Node Config - Router',
    aliases: ['router', 'runtime.cache.mode', 'router.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.router.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Router',
    aliases: ['router', 'runtime.waitForInputs', 'router.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.router.runtime.waitForInputs'],
  },
  {
    ...
    aliases: ['simulation', 'runtime.cache.mode', 'simulation.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.simulation.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Simulation: Entity Modal',
    aliases: ['simulation', 'runtime.waitForInputs', 'simulation.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.simulation.runtime.waitForInputs'],
  },
  {
    ...
    section: 'Node Config - Simulation: Entity Modal',
    aliases: ['simulation', 'simulation.entityId', 'simulation.simulation.entityId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.simulation.simulation.entityId'],
  },
  {
    ...
    section: 'Node Config - Simulation: Entity Modal',
    aliases: ['simulation', 'simulation.entityType', 'simulation.simulation.entityType'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.simulation.simulation.entityType'],
  },
  {
    ...
    section: 'Node Config - Simulation: Entity Modal',
    aliases: ['simulation', 'simulation.productId', 'simulation.simulation.productId'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.simulation.simulation.productId'],
  },
  {
    ...
    aliases: ['string_mutator', 'runtime.cache.mode', 'string_mutator.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - String Mutator',
    aliases: ['string_mutator', 'runtime.waitForInputs', 'string_mutator.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.runtime.waitForInputs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].flags'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].matchMode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].replace'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].search'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].type'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.string_mutator.stringMutator.operations[].useRegex'],
  },
  {
    ...
    aliases: ['template', 'runtime.cache.mode', 'template.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.template.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Template',
    aliases: ['template', 'runtime.waitForInputs', 'template.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.template.runtime.waitForInputs'],
  },
  {
    ...
    section: 'Node Config - Template',
    aliases: ['template', 'template.template', 'template.template.template'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.template.template.template'],
  },
  {
    ...
    aliases: ['trigger', 'runtime.cache.mode', 'trigger.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.trigger.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Trigger: Scheduled Run',
    aliases: ['trigger', 'runtime.waitForInputs', 'trigger.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.trigger.runtime.waitForInputs'],
  },
  {
    ...
    section: 'Node Config - Trigger: Scheduled Run',
    aliases: ['trigger', 'trigger.event', 'trigger.trigger.event'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.trigger.trigger.event'],
  },
  {
    ...
    aliases: ['validation_pattern', 'runtime.cache.mode', 'validation_pattern.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.runtime.cache.mode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.runtime.waitForInputs'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.failPolicy'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.includeRuleIds'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.inputPort'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.learnedRules'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.maxAutofixPasses'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.outputPort'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.rules'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.runtimeMode'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.scope'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.source'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validation_pattern.validationPattern.stackId'],
  },
  {
    ...
    aliases: ['validator', 'runtime.cache.mode', 'validator.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validator.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Validator',
    aliases: ['validator', 'runtime.waitForInputs', 'validator.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validator.runtime.waitForInputs'],
  },
  {
    ...
    section: 'Node Config - Validator',
    aliases: ['validator', 'validator.mode', 'validator.validator.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validator.validator.mode'],
  },
  {
    ...
    section: 'Node Config - Validator',
    aliases: ['validator', 'validator.requiredPaths', 'validator.validator.requiredPaths'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.validator.validator.requiredPaths'],
  },
  {
    ...
    aliases: ['viewer', 'runtime.cache.mode', 'viewer.runtime.cache.mode'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.viewer.runtime.cache.mode'],
  },
  {
    ...
    summary: 'If true, wait until all connected input ports have values before executing the node.',
    section: 'Node Config - Result Viewer',
    aliases: ['viewer', 'runtime.waitForInputs', 'viewer.runtime.waitForInputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.viewer.runtime.waitForInputs'],
  },
  {
    ...
    section: 'Node Config - Result Viewer',
    aliases: ['viewer', 'viewer.outputs', 'viewer.viewer.outputs'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.viewer.viewer.outputs'],
  },
  {
    ...
    section: 'Node Config - Result Viewer',
    aliases: ['viewer', 'viewer.showImagesAsJson', 'viewer.viewer.showImagesAsJson'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node', 'config-field'],
    uiTargets: ['node-config.viewer.viewer.showImagesAsJson'],
  },
  {
    id: 'node_config_gate',
    ...
    section: 'Node Config',
    aliases: ['gate', 'Gate', 'gate config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.gate'],
  },
  {
    id: 'node_config_http',
    ...
    section: 'Node Config',
    aliases: ['http', 'HTTP Fetch', 'http config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.http'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['iterator', 'Iterator', 'iterator config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.iterator'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['learner_agent', 'Learner Agent', 'learner_agent config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.learner_agent'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['mapper', 'JSON Mapper', 'mapper config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.mapper'],
  },
  {
    id: 'node_config_math',
    ...
    section: 'Node Config',
    aliases: ['math', 'Math', 'math config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.math'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['model', 'Model', 'model config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.model'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['mutator', 'Mutator', 'mutator config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.mutator'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['notification', 'Toast Notification', 'notification config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/notification.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.notification'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['parser', 'JSON Parser', 'parser config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.parser'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['playwright', 'Playwright', 'playwright config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.playwright'],
  },
  {
    id: 'node_config_poll',
    ...
    section: 'Node Config',
    aliases: ['poll', 'Poll Job', 'poll config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.poll'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['prompt', 'Prompt', 'prompt config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.prompt'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['regex', 'Regex Grouper', 'regex config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.regex'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['router', 'Router', 'router config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.router'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['simulation', 'Simulation: Entity Modal', 'simulation config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.simulation'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['fetcher', 'Fetcher: Trigger Context', 'fetcher config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.fetcher'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['string_mutator', 'String Mutator', 'string_mutator config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.string_mutator'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['template', 'Template', 'template config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.template'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['trigger', 'Trigger: Scheduled Run', 'trigger config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.trigger'],
  },
  {
  ...
  },
  {
    ...
    section: 'Node Config',
    aliases: ['validation_pattern', 'Validation Pattern', 'validation_pattern config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.validation_pattern'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['validator', 'Validator', 'validator config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.validator'],
  },
  {
    ...
    section: 'Node Config',
    aliases: ['viewer', 'Result Viewer', 'viewer config'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['node-config.viewer'],
  },
  {
    ...
    aliases: ['agent', 'Reasoning Agent', 'palette agent'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.agent'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['ai_description', 'AI Description Generator', 'palette ai_description'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.ai_description'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['api_advanced', 'API Operation (Advanced)', 'palette api_advanced'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.api_advanced'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['audio_oscillator', 'Audio Oscillator', 'palette audio_oscillator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.audio_oscillator'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['audio_speaker', 'Audio Speaker (Mono)', 'palette audio_speaker'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.audio_speaker'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['bundle', 'Bundle', 'palette bundle'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.bundle'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['compare', 'Compare', 'palette compare'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.compare'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['constant', 'Constant', 'palette constant'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.constant'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['context', 'Context Filter', 'palette context'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.context'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['database', 'Database Query', 'palette database'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.database'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['db_schema', 'Database Schema', 'palette db_schema'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.db_schema'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['delay', 'Delay', 'palette delay'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.delay'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/nodes/description_updater.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.description_updater'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['gate', 'Gate', 'palette gate'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.gate'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['http', 'HTTP Fetch', 'palette http'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.http'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['iterator', 'Iterator', 'palette iterator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.iterator'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['learner_agent', 'Learner Agent', 'palette learner_agent'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.learner_agent'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['mapper', 'JSON Mapper', 'palette mapper'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.mapper'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['math', 'Math', 'palette math'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.math'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['model', 'Model', 'palette model'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.model'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['mutator', 'Mutator', 'palette mutator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.mutator'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['notification', 'Toast Notification', 'palette notification'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/notification.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.notification'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['parser', 'JSON Parser', 'palette parser'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.parser'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['playwright', 'Playwright', 'palette playwright'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.playwright'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['poll', 'Poll Job', 'palette poll'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.poll'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['prompt', 'Prompt', 'palette prompt'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.prompt'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['regex', 'Regex Grouper', 'palette regex'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.regex'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['router', 'Router', 'palette router'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.router'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['simulation', 'Simulation: Entity Modal', 'palette simulation'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.simulation'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['fetcher', 'Fetcher: Trigger Context', 'palette fetcher'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.fetcher'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['string_mutator', 'String Mutator', 'palette string_mutator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.string_mutator'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['template', 'Template', 'palette template'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.template'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['trigger', 'Trigger: Scheduled Run', 'palette trigger'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.trigger'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['validation_pattern', 'Validation Pattern', 'palette validation_pattern'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.validation_pattern'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['validator', 'Validator', 'palette validator'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.validator'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['viewer', 'Result Viewer', 'palette viewer'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'nodes', 'palette', 'config', 'node'],
    uiTargets: ['palette.node.viewer'],
  },
  {
    ...
    aliases: ['data signal'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'palette'],
    uiTargets: ['palette.mode.data'],
  },
  {
    ...
    section: 'Node Palette',
    aliases: ['sound signal'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'palette'],
    uiTargets: ['palette.mode.sound'],
  },
  {
    id: 'palette_search',
    ...
    section: 'Node Palette',
    aliases: ['search node palette', 'search nodes'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'palette', 'search'],
    uiTargets: ['palette.search'],
  },
  {
    id: 'palette_toggle',
    ...
    section: 'Node Palette',
    aliases: ['node palette collapse', 'node palette expand'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'palette'],
    uiTargets: ['palette.toggle'],
  },
  {
    ...
    aliases: ['{{lines}}'],
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'regex'],
    uiTargets: ['regex.placeholder.lines'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'regex'],
    uiTargets: ['regex.placeholder.text'],
  },
  {
    ...
    docPath: '/docs/ai-paths/semantic-grammar/spec-v1.md',
    tags: ['ai-paths', 'manual', 'controls', 'regex'],
    uiTargets: ['regex.placeholder.value'],
  },
  {
    ...
    aliases: ['agent', 'Reasoning Agent', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/agent.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.agent'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['ai_description', 'AI Description Generator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/ai_description.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.ai_description'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['api_advanced', 'API Operation (Advanced)', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/api_advanced.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.api_advanced'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['audio_oscillator', 'Audio Oscillator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_oscillator.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.audio_oscillator'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['audio_speaker', 'Audio Speaker (Mono)', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/audio_speaker.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.audio_speaker'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['bundle', 'Bundle', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/bundle.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.bundle'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['compare', 'Compare', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/compare.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.compare'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['constant', 'Constant', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/constant.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.constant'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['context', 'Context Filter', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/context.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.context'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['database', 'Database Query', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/database.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.database'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['db_schema', 'Database Schema', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/db_schema.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.db_schema'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['delay', 'Delay', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/delay.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.delay'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['description_updater', 'Description Updater (Deprecated)', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/description_updater.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.description_updater'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['gate', 'Gate', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/gate.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.gate'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['http', 'HTTP Fetch', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/http.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.http'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['iterator', 'Iterator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/iterator.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.iterator'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['learner_agent', 'Learner Agent', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/learner_agent.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.learner_agent'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['mapper', 'JSON Mapper', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mapper.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.mapper'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['math', 'Math', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/math.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.math'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['model', 'Model', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/model.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.model'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['mutator', 'Mutator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/mutator.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.mutator'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['notification', 'Toast Notification', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/notification.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.notification'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['parser', 'JSON Parser', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/parser.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.parser'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['playwright', 'Playwright', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/playwright.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.playwright'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['poll', 'Poll Job', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/poll.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.poll'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['prompt', 'Prompt', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/prompt.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.prompt'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['regex', 'Regex Grouper', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/regex.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.regex'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['router', 'Router', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/router.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.router'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['simulation', 'Simulation: Entity Modal', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/simulation.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.simulation'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['string_mutator', 'String Mutator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/string_mutator.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.string_mutator'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['template', 'Template', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/template.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.template'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['trigger', 'Trigger: Scheduled Run', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/trigger.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.trigger'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['validation_pattern', 'Validation Pattern', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validation_pattern.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.validation_pattern'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['validator', 'Validator', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/validator.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.validator'],
  },
  {
    ...
    section: 'Semantic Grammar',
    aliases: ['viewer', 'Result Viewer', 'semantic grammar'],
    docPath: '/docs/ai-paths/semantic-grammar/nodes/viewer.json',
    tags: ['ai-paths', 'semantic-grammar', 'nodes', 'semantic-node'],
    uiTargets: ['docs.semantic.viewer'],
  },
  {
    ...
    section: 'Overview',
    aliases: ['workflow', 'overview', 'ai paths'],
    docPath: '/docs/ai-paths/semantic-grammar/README.md',
    tags: ['ai-paths', 'manual', 'controls', 'overview'],
    uiTargets: ['ai-paths-root'],
  },
];
