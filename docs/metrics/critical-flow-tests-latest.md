...
Generated at: 2026-03-08T19:10:10.631Z
...
| AI Paths Run Execution | Run completion without fallback/error path | PASS | 5.3s | 0 | `__tests__/features/ai/ai-paths/services/path-run-executor.test.ts` |
| Case Resolver OCR + Capture Mapping | Queue-to-review completion without manual recovery | PASS | 3.7s | 0 | `src/features/case-resolver/__tests__/workspace-persistence.test.ts` |
