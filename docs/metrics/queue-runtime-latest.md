...
Generated at: 2026-04-15T09:38:34.831Z
...
| --- | --- | --- | --- | --- | --- | --- |
| agent | src/features/ai/agent-runtime/workers/agentQueue.ts | yes | yes | yes | startAgentQueue, startAiInsightsQueue, startAiPathRunQueue, startBaseExportQueue, startBaseImportQueue, startChatbotJobQueue, startImageStudioRunQueue, startImageStudioSequenceQueue, startFilemakerSocialPipelineQueue, startFilemakerSocialSchedulerQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/ai.ts, src/server/queues/integrations.ts, src/server/queues/filemaker.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
...
| base-export | src/features/integrations/workers/baseExportQueue.ts | no | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
| base-import | src/features/integrations/workers/baseImportQueue.ts | no | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
...
| social-publishing-pipeline | src/features/filemaker/social/workers/socialPublishingPipelineQueue.ts | no | yes | yes | startFilemakerSocialPipelineQueue, startFilemakerSocialSchedulerQueue | src/server/queues/filemaker.ts |
| social-publishing-scheduler | src/features/filemaker/social/workers/socialPublishingSchedulerQueue.ts | no | yes | yes | startFilemakerSocialPipelineQueue, startFilemakerSocialSchedulerQueue | src/server/queues/filemaker.ts |
| playwright-programmable-listings | src/features/integrations/workers/playwrightListingQueue.ts | no | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
...
| tradera-listings | src/features/integrations/workers/traderaListingQueue.ts | no | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
| tradera-relist-scheduler | src/features/integrations/workers/traderaRelistSchedulerQueue.ts | yes | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
| vinted-listings | src/features/integrations/workers/vintedListingQueue.ts | no | yes | yes | startBaseExportQueue, startBaseImportQueue, startPlaywrightListingQueue, startProductAiJobQueue, startProductSyncBackfillQueue, startProductSyncSchedulerQueue, startTraderaListingQueue, startTraderaRelistSchedulerQueue, startVintedListingQueue | src/server/queues/integrations.ts, src/server/queues/product-ai.ts, src/server/queues/product-sync.ts |
