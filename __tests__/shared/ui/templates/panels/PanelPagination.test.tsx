...
describe('PanelPagination', () => {
  ...
  it('calls onPageChange when navigation works', () => {
    ...
    render(<PanelPagination {...defaultProps} onPageChange={onPageChange} page={1} />);
  ...
  it('disables next button on last page', () => {
    render(<PanelPagination {...defaultProps} page={10} totalCount={100} />);
    const buttons = screen.getAllByRole('button');
  ...
  it('returns null when totalCount is 0', () => {
    const { container } = render(<PanelPagination {...defaultProps} totalCount={0} />);
