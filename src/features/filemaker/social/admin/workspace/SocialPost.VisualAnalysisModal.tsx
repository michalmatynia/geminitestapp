    ...
    >
      <div className='space-y-4'>
        ...
        {visualAnalysisResult ? (
          ...
          <div className='rounded-xl border border-border/60 bg-background/40 px-3 py-2 text-sm text-muted-foreground'>
            {isSavedVisualAnalysisStale && hasSavedVisualAnalysis
              ? 'Rerun image analysis first. After reviewing the refreshed visual description, use Generate post with analysis to create the published update in the next AI pass.'
              : hasFailedSavedAnalysis
                ? 'Rerun image analysis first. The latest saved run failed, so there is no usable visual description to generate from yet.'
              : 'Run image analysis first. After reviewing the visual description, use Generate post with analysis to create the published update in the next AI pass.'}
          </div>
        )}
      </div>
    </FormModal>
