...
Generated at: 2026-03-17T13:50:54.318Z

## Snapshot

- Source files: 6553
- Source lines: 1050296
- use client files: 0
- Files >= 1000 LOC: 0
- Files >= 1500 LOC: 0
...
| Route | LOC |
| --- | ---: |
| `src/app/api/kangur/[[...path]]/route.ts` | 1146 |
...
| `src/features/kangur/ui/components/KangurAssignmentManager.tsx` | 1130 |
| `src/features/kangur/admin/AdminKangurLessonsManagerPage.tsx` | 1115 |
