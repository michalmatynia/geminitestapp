...
Generated at: 2026-03-08T12:31:31.558Z
...
| /admin/integrations | admin | PASS | 2.9s | 0 |
| /admin/case-resolver | admin | PASS | 3.8s | 0 |
| /admin/cms | admin | PASS | 4.7s | 0 |
| /admin/ai-paths | admin | PASS | 3.7s | 0 |
| /admin/image-studio | admin | PASS | 4.7s | 0 |
| /admin/chatbot | admin | PASS | 2.9s | 0 |
| /admin/agentcreator | admin | PASS | 2.9s | 0 |
| /admin/prompt-engine/validation | admin | PASS | 2.8s | 0 |
| /admin/kangur | admin | PASS | 5.3s | 0 |
| /admin/databases/engine | admin | PASS | 3.9s | 0 |
| /admin/brain?tab=routing | admin | PASS | 3.8s | 0 |
