...
function MiniRichTextEditor({
  ...
  useEffect((): void | (() => void) => {
    ...
    const updateFormat = (): void => {
      if (editor.isActive('heading', { level: 1 })) { setFormatValue('heading-1'); return; }
      if (editor.isActive('heading', { level: 2 })) { setFormatValue('heading-2'); return; }
      if (editor.isActive('heading', { level: 3 })) { setFormatValue('heading-3'); return; }
