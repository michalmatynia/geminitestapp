...
Generated at: 2026-03-08T12:42:35.789Z
...
| /admin | admin | PASS | 2.3s | 0 |
| /admin/products | admin | PASS | 2.8s | 0 |
| /admin/notes | admin | PASS | 2.6s | 0 |
| /admin/integrations | admin | PASS | 2.4s | 0 |
| /admin/case-resolver | admin | PASS | 3.9s | 0 |
| /admin/cms | admin | PASS | 2.3s | 0 |
| /admin/ai-paths | admin | PASS | 3.7s | 0 |
| /admin/image-studio | admin | PASS | 3.6s | 0 |
| /admin/chatbot | admin | PASS | 2.5s | 0 |
| /admin/agentcreator | admin | PASS | 2.3s | 0 |
| /admin/prompt-engine/validation | admin | PASS | 2.6s | 0 |
| /admin/kangur | admin | PASS | 3.7s | 0 |
| /admin/databases/engine | admin | PASS | 2.9s | 0 |
| /admin/brain?tab=routing | admin | PASS | 2.7s | 0 |
