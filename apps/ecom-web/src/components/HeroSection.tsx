    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center px-8 md:px-14 lg:px-16 xl:px-20 w-full lg:w-[55%] py-20 lg:py-28">
        ...
        <div className="flex items-center gap-3 mb-10 animate-slide-up delay-0">
          ...
          />
          <span className="type-label tracking-[0.22em]" style={{ color: 'var(--accent)' }}>
            {content.status}
          </span>
        </div>
      ...
      <div
        ...
        style={{ background: 'var(--hero-visual-bg)' }}
      >
        {/* Dot grid */}
        ...
        {/* Corner brackets */}
        <div className="absolute top-8 left-8 w-10 h-10 z-10" style={{ borderTop: '2px solid var(--accent)', borderLeft: '2px solid var(--accent)', opacity: 0.7 }} />
        <div className="absolute top-8 right-8 w-10 h-10 z-10" style={{ borderTop: '2px solid var(--accent)', borderRight: '2px solid var(--accent)', opacity: 0.7 }} />
        <div className="absolute bottom-8 left-8 w-10 h-10 z-10" style={{ borderBottom: '2px solid var(--accent)', borderLeft: '2px solid var(--accent)', opacity: 0.7 }} />
        <div className="absolute bottom-8 right-8 w-10 h-10 z-10" style={{ borderBottom: '2px solid var(--accent)', borderRight: '2px solid var(--accent)', opacity: 0.7 }} />
          ...
          >
            ...
            <div className="flex justify-center mb-8">
              <svg viewBox="0 0 200 200" className="w-44 h-44">
                ...
                />
                {/* Inner facets */}
                <line x1="100" y1="60" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                <line x1="130" y1="88" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                <line x1="130" y1="118" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                <line x1="100" y1="140" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                <line x1="70" y1="118" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                <line x1="70" y1="88" x2="100" y2="100" stroke="rgba(var(--accent-rgb),0.3)" strokeWidth="0.8"/>
                {/* Corner nodes */}
                <circle cx="100" cy="12" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                <circle cx="176" cy="56" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                <circle cx="176" cy="144" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                <circle cx="100" cy="188" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                <circle cx="24" cy="144" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                <circle cx="24" cy="56" r="3" fill="rgba(var(--accent-rgb),0.5)" />
                {/* Glow dot center */}
                <circle cx="100" cy="100" r="5" fill="rgba(var(--accent-rgb),0.8)" style={{ filter: 'drop-shadow(0 0 6px rgba(var(--accent-rgb),0.9))' }} />
              </svg>
            </div>
            ...
            <div className="text-center">
              ...
              <div
                ...
                style={{ color: 'var(--soft-gold)', fontSize: '1.1rem', textShadow: '0 0 12px rgba(var(--gold-rgb),0.4)' }}
              >
                {content.panelPrice}
              </div>
            </div>
