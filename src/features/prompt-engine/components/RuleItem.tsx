...
function RuleItemHeader({ isCollapsed, setCollapsed }: RuleItemHeaderProps): React.JSX.Element {
  const { draft, rule } = useRuleItemContext();
...
function RuleItemBasicSettings(): React.JSX.Element | null {
...
function RuleItemExploderSettings(): React.JSX.Element | null {
...
function RuleItemExecutionSettings(): React.JSX.Element | null {
  const { rule, patchRule } = useRuleItemContext();
...
function RuleItemAutofixSettings(): React.JSX.Element | null {
...
function RuleItemRawEditor(): React.JSX.Element {
