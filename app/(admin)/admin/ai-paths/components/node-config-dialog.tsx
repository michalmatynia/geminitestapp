              ...
              const queryEditor = (
                <div className="space-y-4 rounded-md border border-gray-800 bg-gray-900/40 p-3">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              updateQueryConfig(
                                {
                                  mode: "preset",
                                  preset: hasEntityIdInput ? "by_entityId" : "by_productId",
                                },
                                { syncPreset: true }
                              )
                            }
                  ...
                  {showQueryExtras &&
                    ...
                    queryConfig.preset === "by_productId" && (
                      <div className="rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-[11px] text-amber-100">
                        You connected <span className="text-amber-200">entityId</span>, but the
                        preset is <span className="text-amber-200">By productId</span>. This will
                        query the <span className="text-amber-200">productId</span> field and
                        likely return no results for Products.
                        <div className="mt-2">
                          <Button
                            type="button"
                            ...
                            onClick={() =>
                              updateQueryConfig(
                                { mode: "preset", preset: "by_entityId" },
                                { syncPreset: true }
                              )
                            }
                          >
                  ...
                  {showQueryExtras &&
                    ...
                    queryConfig.preset === "by_entityId" && (
                      <div className="rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-[11px] text-amber-100">
                        You connected <span className="text-amber-200">productId</span>, but the
                        preset is <span className="text-amber-200">By entityId</span>. This will
                        query the <span className="text-amber-200">entityId</span> field.
                        <div className="mt-2">
                          <Button
                            type="button"
                            className="rounded-md border border-amber-500/40 px-3 py-1 text-[11px] text-amber-200 hover:bg-amber-500/10"
                            onClick={() =>
                              updateQueryConfig(
                                { mode: "preset", preset: "by_productId" },
                                { syncPreset: true }
                              )
                            }
                          >
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <Select
                        value={queryConfig.mode}
                        onValueChange={(value) => {
                          const nextMode = value as DbQueryConfig["mode"];
                          updateQueryConfig(
                            {
                              mode: nextMode,
                              queryTemplate:
                                nextMode === "custom" ? queryTemplateValue : queryConfig.queryTemplate,
                            },
                            { syncPreset: nextMode === "preset" }
                          );
                        }}
                      >
                        <SelectTrigger className="mt-2 w-full border-gray-800 bg-gray-950/70 text-sm text-white">
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              updateQueryConfig(
                                { preset: value as DbQueryConfig["preset"], mode: "preset" },
                                { syncPreset: true }
                              )
                            }
                          >
                  ...
                  <div>
                    ...
                    {queryConfig.mode === "preset" && (
                      <p className="mt-2 text-[11px] text-gray-500">
                        Editing the query switches to custom mode.
                      </p>
                    )}
                    <p className="mt-2 text-[11px] text-gray-500">
