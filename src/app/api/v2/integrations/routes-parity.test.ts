...
const migratedRouteHandlerPaths = [
  ...
  '[id]/connections/[connectionId]/google/authorize/route-handler.ts',
  '[id]/connections/[connectionId]/google/callback/route-handler.ts',
  '[id]/connections/[connectionId]/google/disconnect/route-handler.ts',
  'google/callback/route-handler.ts',
...
const removedLegacyAliasRoutes = [
  ...
  '[id]/connections/[connectionId]/linkedin/authorize/route.ts',
  '[id]/connections/[connectionId]/linkedin/callback/route.ts',
  '[id]/connections/[connectionId]/linkedin/disconnect/route.ts',
