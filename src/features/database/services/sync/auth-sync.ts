...
export const syncAuthSecurityProfiles: SyncHandler = async ({ mongo, prisma, normalizeId, toDate }) => {
...
export const syncAccountsPrismaToMongo: SyncHandler = async ({ mongo, prisma, toObjectIdMaybe }) => {
...
export const syncSessionsPrismaToMongo: SyncHandler = async ({ mongo, prisma, toObjectIdMaybe }) => {
