...
> = {
  ...
  pl: {
    corePalette: {
      title: 'Paleta glowna',
      subtitle: 'Wspolne tony dla wyroznien, tekstu i stanow informacji zwrotnej w Kangur.',
    },
    textOverrides: {
    ...
    backgroundsSurfaces: {
      title: 'Tla i powierzchnie',
      subtitle: 'Bazowe kolory strony, paneli, kart i powloki czatu.',
    },
    buttons: {
      title: 'Przyciski',
      subtitle: 'Kolory glownych i drugorzednych CTA uzywanych w publicznym storefrontcie.',
    },
    buttonShadows: {
      title: 'Cienie przyciskow',
      subtitle: 'Cienie zewnetrzne dla obudowy glownych i drugorzednych przyciskow.',
    },
    gelEffects: {
      title: 'Efekty zelowe',
      subtitle: 'Polysk, cienie wewnetrzne, cien tekstu i zewnetrzna poswiata dla zelowych przyciskow.',
    },
    navigationPills: {
      title: 'Pills nawigacji',
      subtitle: 'Styl pills dla sidebaru i zakladek w stanie domyslnym i aktywnym.',
    },
    gradients: {
      title: 'Gradienty',
      subtitle: 'Gradienty akcentow uzywane na kafelkach lekcji, badgeach i dekoracyjnych wyroznieniach.',
    },
    homeActions: {
      title: 'Akcje strony glownej',
      subtitle:
        'Motywuj cztery glowne przyciski strony glownej (ikony pozostaja bez zmian). Puste pole zachowuje domyslny ton.',
    },
    progressBars: {
      title: 'Paski postepu',
      subtitle: 'Kolory toru dla wskaznikow postepu w Kangur.',
    },
    inputs: {
      title: 'Pola',
    ...
    typographyLayout: {
      title: 'Typografia i uklad',
      subtitle: 'Fonty, rytm bazowego tekstu i szerokosc strony uzywane przez powloke Kangur.',
    },
    shapeSpacing: {
      title: 'Ksztalt i odstepy',
      subtitle: 'Wspolne promienie dla paneli, nawigacji, przyciskow i pol.',
    },
    shadowsDepth: {
      title: 'Cienie i glebia',
      subtitle: 'Dostroj miekkosc cieni szklanego panelu i kart.',
    },
  },
};
...
> = {
  ...
  pl: {
    daily: {
      label: 'Motyw dzienny',
      resetLabel: 'Przywroc motyw dzienny',
      resetDescription: 'Nadpisuje ten motyw domyslnym presetem dziennym.',
      toastMessage: 'Motyw dzienny przywrocony do domyslnych ustawien.',
    },
    dawn: {
      label: 'Motyw switowy',
      resetLabel: 'Przywroc motyw switowy',
      resetDescription: 'Nadpisuje ten motyw domyslnym presetem switu.',
      toastMessage: 'Motyw switowy przywrocony do domyslnych ustawien.',
    },
    sunset: {
      label: 'Motyw zachodu',
      resetLabel: 'Przywroc motyw zachodu',
      resetDescription: 'Nadpisuje ten motyw domyslnym presetem zachodu.',
      toastMessage: 'Motyw zachodu przywrocony do domyslnych ustawien.',
    },
    nightly: {
      label: 'Motyw nocny',
      resetLabel: 'Przywroc motyw nocny',
      resetDescription: 'Nadpisuje ten motyw domyslnym presetem nocnym.',
      toastMessage: 'Motyw nocny przywrocony do domyslnych ustawien.',
    },
  },
};
...
> = {
  ...
  pl: [
    ...
    { value: '500', label: 'Sredni (500)' },
    { value: '600', label: 'Polgruby (600)' },
...
> = {
  ...
  pl: {
    ...
    restoreDefaultButton: 'Przywroc domyslne',
    restoring: 'Przywracam...',
    resetError: 'Nie udalo sie przywrocic motywu.',
    auto: 'Auto',
    progressTrackColorPickerAria: 'Wybierak koloru toru postepu',
    progressTrackColorValueAria: 'Wartosc koloru toru postepu',
  },
};
...
const PL_FIELD_LABELS: Record<string, string> = {
  ...
  'Page Background': 'Tlo strony',
  'Surface Background': 'Tlo powierzchni',
  'Card Background': 'Tlo karty',
  'Container Background': 'Tlo kontenera',
  'Panel Gradient Start': 'Poczatek gradientu panelu',
  'Panel Gradient End': 'Koniec gradientu panelu',
  'Panel Transparency': 'Przezroczystosc panelu',
  'Base Border': 'Bazowa ramka',
  'Surface Border': 'Ramka powierzchni',
  'Primary Button Background': 'Tlo glownego przycisku',
  'Primary Button Text': 'Tekst glownego przycisku',
  'Secondary Button Background': 'Tlo drugorzednego przycisku',
  'Secondary Button Text': 'Tekst drugorzednego przycisku',
  ...
  'Button Font Weight': 'Grubosc fontu przycisku',
