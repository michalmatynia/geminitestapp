...
type PortContractRecord = Record<string, NodePortContract>;

const resolveDefinitionForNode = (node: AiNode): NodeDefinition | null => {
...
const applyDefinitionContractsToNode = (node: AiNode): { node: AiNode; changed: boolean } => {
