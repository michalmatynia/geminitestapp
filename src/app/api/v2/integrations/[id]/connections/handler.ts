...
export async function getHandler(
  ...
  const payload = connections.map((connection: (typeof connections)[number]) => ({
    ...
    googleTokenUpdatedAt: connection.googleTokenUpdatedAt ?? null,
    googleExpiresAt: connection.googleExpiresAt ?? null,
...
export async function postHandler(
  ...
  return NextResponse.json({
    ...
    hasGoogleAccessToken: Boolean(created.googleAccessToken),
    googleTokenUpdatedAt: created.googleTokenUpdatedAt ?? null,
    googleExpiresAt: created.googleExpiresAt ?? null,
    googleScope: created.googleScope ?? null,
    ...
    pracujLoginMode: created.pracujLoginMode ?? null,
    pracujAuthMode: created.pracujAuthMode ?? null,
    pracujSalaryExpectation: created.pracujSalaryExpectation ?? null,
    pracujCooperationForm: created.pracujCooperationForm ?? null,
