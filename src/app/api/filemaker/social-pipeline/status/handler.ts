...
import {
  getSocialPublishingPipelineQueue,
  getSocialPublishingPipelineWorkerHeartbeat,
  SOCIAL_PUBLISHING_PIPELINE_REPEAT_EVERY_MS,
  SOCIAL_PUBLISHING_PIPELINE_WORKER_HEARTBEAT_TTL_MS,
...
export async function getHandler(
  ...
  const workerHeartbeatTime = await getSocialPublishingPipelineWorkerHeartbeat();
  ...
  const hasFreshWorkerHeartbeat =
    ...
    timeSinceWorkerHeartbeat <= SOCIAL_PUBLISHING_PIPELINE_WORKER_HEARTBEAT_TTL_MS;
