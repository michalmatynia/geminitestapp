...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@kangur/contracts': path.resolve(__dirname, './packages/kangur-contracts/src'),
      '@kangur/core': path.resolve(__dirname, './packages/kangur-core/src'),
      '@kangur/api-client': path.resolve(__dirname, './packages/kangur-api-client/src'),
      '@kangur/platform': path.resolve(__dirname, './packages/kangur-platform/src'),
