...
export const ENGLISH_LESSON_TEMPLATES: Record<EnglishLessonComponentId, KangurLessonTemplate> = {
  ...
  english_going_to: {
    componentId: 'english_going_to',
    subject: 'english',
    ageGroup: 'ten_year_old',
    label: 'English Going To Lesson',
    title: 'English: Going to',
    description: 'Plany na przyszłość z going to w zdaniach, przeczeniach i pytaniach',
    emoji: '🧳',
    color: 'kangur-gradient-accent-sky',
    activeBg: 'bg-sky-500',
  },
  ...
  english_comparatives_superlatives: {
    ...
    subject: 'english',
    ageGroup: 'ten_year_old',
    label: 'English Comparatives and Superlatives Lesson',
    title: 'English: Comparatives & Superlatives',
    description: 'Comparing two things and choosing the top one in a group',
    emoji: '👑',
