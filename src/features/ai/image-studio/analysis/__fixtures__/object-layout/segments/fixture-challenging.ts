...
export const fixtureOffWhiteDrift = (): ObjectLayoutGoldenFixture => {
  const width = 128;
  const height = 96;
...
export const fixtureBorderNoise = (): ObjectLayoutGoldenFixture => {
  const width = 110;
  const height = 82;
...
export const fixtureTouchesBorder = (): ObjectLayoutGoldenFixture => {
  const width = 104;
  const height = 84;
