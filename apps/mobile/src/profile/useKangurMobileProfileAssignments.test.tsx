...
describe('useKangurMobileProfileAssignments', () => {
  it('reuses the shared home assignments feed for the profile surface', () => {
    ...
    const { result } = renderHook(() => useKangurMobileProfileAssignments());
