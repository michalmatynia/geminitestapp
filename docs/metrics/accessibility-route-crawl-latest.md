...
Generated at: 2026-03-17T12:16:56.298Z
...
| --- | --- | --- | ---: | ---: |
| /admin/kangur/settings | admin | PASS | 23.5s | 0 |
| /admin/databases/engine | admin | PASS | 47.2s | 0 |
| /admin/brain?tab=routing | admin | PASS | 22.4s | 0 |
