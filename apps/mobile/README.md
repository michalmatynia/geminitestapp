...
- home dashboard shortcuts for private duel invites, outgoing challenge re-sharing, active lobby rivals with direct challenges, live public duel matches, recent-opponent rematches, series-aware duel cards, a duel leaderboard snapshot, a home lesson-mastery section with review shortcuts, a home recent-lesson-checkpoints section, a compact home next-steps task section, a profile duel summary, a profile recent-lesson-checkpoints section, a results duel recap, a results recent-lesson-checkpoints section, a leaderboard duel section with direct challenges, a leaderboard recent-lesson-checkpoints section, a daily-plan duel section, a daily-plan recent-lesson-checkpoints section, a lessons duel section, a lessons recent-lesson-checkpoints section, checkpoint-aware lesson catalog cards, a practice duel section, a practice recent-lesson-checkpoints section, a duels recent-lesson-checkpoints section, and local lesson checkpoints that immediately update profile/day-plan mastery
