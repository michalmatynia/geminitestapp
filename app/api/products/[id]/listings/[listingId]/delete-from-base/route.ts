...
export const POST = apiHandlerWithParams<{ id: string; listingId: string }>(async (req, _ctx, params) => POST_handler(req, { params: Promise.resolve(params) }), { source: "products.[id].listings.[listingId].delete-from-base.POST" });
