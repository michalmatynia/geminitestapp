...
} from './SocialPublishingSettingsModal.test-support';
import { SocialPublishingSettingsModal } from './SocialPublishingSettingsModal';

describe('SocialPublishingSettingsModal', () => {
  it('owns the documentation, publishing, and capture controls that were removed from the post modal', () => {
    ...
    useSocialPostContextMock.mockReturnValue(
      buildSocialPostContextState({
        ...
        handlePublishingConnectionChange: onLinkedInConnectionChange,
  ...
  it('locks models, project, and publishing settings while Social runtime jobs are in flight', () => {
    ...
    expect(screen.getByLabelText('Default publishing connection')).toBeDisabled();
    expect(screen.getByLabelText('Default publishing connection')).toHaveAttribute(
      'title',
      'Wait for the current Social runtime job to finish.'
    );
  });
