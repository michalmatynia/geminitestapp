...
const AdminFilemakerOrganizationEditPageContext = createContext<AdminFilemakerOrganizationEditPageContextValue | null>(null);

export function AdminFilemakerOrganizationEditPageProvider({ children }: { children: React.ReactNode }): React.JSX.Element {
...
export function useAdminFilemakerOrganizationEditPageContext(): AdminFilemakerOrganizationEditPageContextValue {
  ...
  if (!context) {
    throw new Error('useAdminFilemakerOrganizationEditPageContext must be used within AdminFilemakerOrganizationEditPageProvider');
  }
  return context;
}
