I can't drad documents in Case Resolver

Migrated:
-Case Resolver & Case Resolver Folder Tree
-Ai-Paths
-Products
-Runtime
...
6. More customization controls (layout, typography, media, effects)
7. Animation/interaction upgrades

8. Add a one-click “Generate + Save scheme” button directly in the schemes
   list.
9. Add a dedicated /api/cms/theme-ai/stream endpoint and persist AI prompts
   per scheme.
