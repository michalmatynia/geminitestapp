...
type LocalizedFilemakerPreferencesPageProps = {
...
export default async function LocalizedFilemakerPreferencesPage({
  params,
  searchParams,
}: LocalizedFilemakerPreferencesPageProps): Promise<JSX.Element> {
  await params;
