...
import { persistCheckpoint } from "@/shared/lib/agent/memory/checkpoint";
import type { PlanHierarchy } from "@/shared/lib/agent/planning/utils";

type CheckpointState = ReturnType<
  typeof import("@/shared/lib/agent/memory/checkpoint").parseCheckpoint
>;
