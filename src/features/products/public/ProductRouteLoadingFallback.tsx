...
function ProductRouteLoadingHeader(): React.JSX.Element {
  return (
...
function ProductRouteLoadingBreadcrumb(): React.JSX.Element {
  return (
    <div className='flex items-center gap-3'>
...
function ProductRouteLoadingGallery(): React.JSX.Element {
  return (
...
function ProductRouteLoadingDetails(): React.JSX.Element {
  return (
    <div className='space-y-4'>
...
function ProductRouteLoadingContent(): React.JSX.Element {
  return (
    <div data-testid='product-route-loading-fallback-content'>
      <div className='mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 md:px-6 lg:py-12'>
        <ProductRouteLoadingBreadcrumb />
        <div className='grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(20rem,0.95fr)]'>
          <ProductRouteLoadingGallery />
          <ProductRouteLoadingDetails />
        </div>
      </div>
    </div>
  );
...
export function ProductRouteLoadingFallback(): React.JSX.Element {
  return (
    ...
    >
      <ProductRouteLoadingHeader />
      <ProductRouteLoadingContent />
    </div>
  );
}
