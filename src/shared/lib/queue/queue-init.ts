...
export const initializeQueues = (): void => {
  ...
  void (async (): Promise<void> => {
    ...
    const queueModules = await Promise.all([
      ...
      import('@/shared/lib/ai/insights/workers/aiInsightsQueue'),
      ...
      import('@/shared/lib/integrations/workers/baseImportQueue'),
      import('@/shared/lib/product-sync/workers/productSyncQueue'),
      import('@/shared/lib/product-sync/workers/productSyncBackfillQueue'),
      import('@/shared/lib/product-sync/workers/productSyncSchedulerQueue'),
