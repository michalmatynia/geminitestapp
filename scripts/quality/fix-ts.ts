...
content1 = content1.replace(
  ...
  `} from '@/features/integrations/product-integrations-adapter';\nimport type { TraderaQuickListFeedbackStatus } from '@/features/integrations/utils/traderaQuickListFeedback';`
);
// just in case single import was used:
content1 = content1.replace(`from './traderaQuickListFeedback';`, `from '@/features/integrations/product-integrations-adapter';`);
...
content2 = content2.replace(`from './traderaQuickListFeedback';`, `from '@/features/integrations/product-integrations-adapter';`);
...
content3 = content3.replace(`from '@/features/products/components/list/columns/buttons/traderaQuickListFeedback';`, `from '@/features/integrations/product-integrations-adapter';`);
