...
const ROUTES: CatchAllRouteDefinition<PatternToken>[] = [
  ...
  { pattern: ['runtime-create', param('requestId')], loader: () => import('../runtime-create/[requestId]/route-handler') },
  ...
  { pattern: ['pages', 'data-sync', 'categories'], loader: () => import('../pages/data-sync/categories/route-handler') },
  ...
  { pattern: ['marketplace-copy-debrand', 'run'], loader: () => import('../marketplace-copy-debrand/run/route-handler') },
  ...
  { pattern: ['scrape-profiles'], loader: () => import('../scrape-profiles/route-handler') },
  { pattern: ['scrape-profiles', 'run'], loader: () => import('../scrape-profiles/run/route-handler') },
  { pattern: ['scrape-profiles', 'run', 'status'], loader: () => import('../scrape-profiles/run/status/route-handler') },
  { pattern: ['scrape-profiles', 'run', param('jobId'), 'pause'], loader: () => import('../scrape-profiles/run/[jobId]/pause/route-handler') },
  { pattern: ['scrape-profiles', 'run', param('jobId'), 'resume'], loader: () => import('../scrape-profiles/run/[jobId]/resume/route-handler') },
  { pattern: ['scraped-source', 'link'], loader: () => import('../scraped-source/link/route-handler') },
  { pattern: ['scraped-source', 'check-status'], loader: () => import('../scraped-source/check-status/route-handler') },
  { pattern: ['scraped-source', 'prepare-purchase'], loader: () => import('../scraped-source/prepare-purchase/route-handler') },
  { pattern: ['scraped-source', 'run-purchase'], loader: () => import('../scraped-source/run-purchase/route-handler') },
  ...
  { pattern: ['scans', param('scanId'), 'diagnostics'], loader: () => import('../scans/[scanId]/diagnostics/route-handler') },
  { pattern: ['scans', param('scanId'), 'diagnostics', param('filename')], loader: () => import('../scans/[scanId]/diagnostics/[filename]/route-handler') },
  ...
  { pattern: ['scans', 'amazon', 'extract-candidate'], loader: () => import('../scans/amazon/extract-candidate/route-handler') },
