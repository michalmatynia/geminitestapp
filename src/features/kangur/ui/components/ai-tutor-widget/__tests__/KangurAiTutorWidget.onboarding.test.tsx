...
import type { TutorHomeOnboardingStepKind } from '@/features/kangur/ui/components/ai-tutor-widget/KangurAiTutorWidget.types';
...
vi.mock('@/features/kangur/ui/context/KangurAuthContext', () => ({
  ...
  useOptionalKangurAuthSessionState: () => {
    const auth = mocks.useOptionalKangurAuthMock();
    if (!auth) {
      return null;
    }
    return {
...
vi.mock('@/features/kangur/ui/context/KangurLoginModalContext', () => ({
  ...
  useKangurLoginModalState: mocks.useKangurLoginModalMock,
