...
export const integrationConnectionBasicSchema = z.object({
  ...
  hasGoogleAccessToken: z.boolean().optional(),
  googleScope: z.string().nullable().optional(),
  googleExpiresAt: z.string().nullable().optional(),
  googleTokenUpdatedAt: z.string().nullable().optional(),
  baseLastInventoryId: z.string().nullable().optional(),
  jobApplicationPersonId: z.string().nullable().optional(),
  jobApplicationPersonName: z.string().nullable().optional(),
