...
export function Q5Illustration() {
  ...
  const cells = [
    ...
    // number 2: _ 8 9 8
    [false, true, true, true, '898'],
    // number 3: 4 8 _ _
    [true, true, false, false, '48'],
  ];
...
export function Q8Illustration() {
  ...
  // Answer C: add one block on top of the stack (2nd position, layer 2)
  const cBlocks = [...afterBlocks, { col: 1, row: 0, layer: 2 }];
...
export function Q11Illustration() {
  ...
  const s = 12; // scale: 1cm = 1px approx, scaled down
  const rw = 23,
