...
export function DuelsJoinRouteView({
  ...
  const renderJoining = (): React.JSX.Element => (
    <Card>
      <MessageCard
        title={copy({
  ...
  const renderPreparing = (): React.JSX.Element => (
    <Card>
      <MessageCard
        title={copy({
  ...
  const renderContent = (): React.JSX.Element => {
    ...
    if (isJoiningFromRoute || isActionPending) {
      return renderJoining();
    }

    if (routeJoinError !== null || lobbyActionError !== null) {
      return renderError();
    }
