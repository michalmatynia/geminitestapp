...
const REFERENCE_DETAILS: Partial<Record<string, ReferenceDetail>> = {
  ...
  'page:kangur-lessons': {
    ...
    semanticText: {
      pl: 'Ekran lekcji w Kangurze. To tutaj uczeń znajduje lekcje, biblioteke lekcji i wraca do tematów.',
  ...
  'page:kangur-tests': {
    ...
    semanticText: {
      pl: 'Ekran testow w Kangurze. To tutaj uczeń znajduje testy, wraca do testow i przechodzi do zestawow testowych. Gdy pyta, gdzie są testy albo jak wrócić do testow, odpowiedzia jest ta strona.',
