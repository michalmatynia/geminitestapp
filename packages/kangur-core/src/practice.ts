...
> = {
  ...
  logical_classification: [
    ...
    {
      question: 'Co pokazuje czesc wspolna w diagramie Venna?',
      answer: 'elementy nalezace do obu grup',
      choices: [
        'elementy spoza wszystkich grup',
        'elementy nalezace do obu grup',
        'tylko najwieksza grupe',
        'same bledne odpowiedzi',
      ],
    },
    {
    ...
    {
      question: 'Od czego trzeba zaczac klasyfikacje?',
      answer: 'od ustalenia wspolnej cechy',
      choices: [
        'od zgadywania',
        'od ustalenia wspolnej cechy',
  ...
  logical_reasoning: [
    {
      question: 'Jesli liczba jest parzysta, to dzieli sie przez 2. Co wiemy o liczbie 8?',
      answer: 'dzieli sie przez 2',
      choices: ['jest nieparzysta', 'dzieli sie przez 2', 'musi byc wieksza od 100', 'nie mozna nic powiedziec'],
    },
    {
      question: 'Ktory kwantyfikator oznacza, ze twierdzenie dotyczy kazdego przypadku?',
      answer: 'wszyscy',
      choices: ['wszyscy', 'niektorzy', 'zaden', 'czasami'],
    },
    {
      question: 'Ktore zdanie jest prawdziwe?',
      answer: '4 + 3 = 7',
      choices: ['4 + 3 = 7', 'trojkat ma 4 boki', '9 jest liczba parzysta', 'jesli pada deszcz, to zawsze jest noc'],
    },
    {
      question: 'Co jest dobrym pierwszym krokiem przy rozwiazywaniu zagadki logicznej?',
      answer: 'wypisz fakty pewne i bezposrednie',
      choices: [
        'zgadnij najbardziej prawdopodobna odpowiedz',
        'pomin polowe wskazowek',
        'wypisz fakty pewne i bezposrednie',
        'wybierz najdluzsza odpowiedz',
      ],
    },
    {
      question: 'Jesli wszystkie psy szczekaja, a Burek jest psem, to jaki jest wniosek?',
      answer: 'Burek szczeka',
      choices: ['Burek szczeka', 'kazde zwierze szczeka', 'Burek jest kotem', 'nie da sie nic ustalic'],
    },
    {
      question: 'Co oznacza slowo "niektorzy" w zdaniu logicznym?',
      answer: 'tylko czesc przypadkow',
      choices: ['kazdy przypadek', 'zaden przypadek', 'tylko czesc przypadkow', 'to samo co wszyscy'],
    },
  ],
  logical_analogies: [
    {
