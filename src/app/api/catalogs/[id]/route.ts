...
export const PUT = apiHandlerWithParams<{ id: string }>(async (req: NextRequest, _ctx: ApiHandlerContext, params: { id: string }) => PUT_handler(req, { params: Promise.resolve(params) }), { source: "catalogs.[id].PUT" });
export const DELETE = apiHandlerWithParams<{ id: string }>(async (req: NextRequest, _ctx: ApiHandlerContext, params: { id: string }) => DELETE_handler(req, { params: Promise.resolve(params) }), { source: "catalogs.[id].DELETE" });
