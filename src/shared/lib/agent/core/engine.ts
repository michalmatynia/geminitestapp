...
import { logAgentAudit } from "@/shared/lib/agent/audit";
import { validateAndAddAgentLongTermMemory } from "@/shared/lib/agent/memory";
import { runAgentTool } from "@/shared/lib/agent/tools";
import {
  launchBrowser,
  createBrowserContext,
} from "@/shared/lib/agent/tools/playwright/browser";
...
import {
  ...
  DEBUG_CHATBOT,
} from "@/shared/lib/agent/core/config";
import { reminderList } from "@/shared/lib/agent/core/utils";
import {
  appendTaskTypeToPrompt,
  decideNextAction,
} from "@/shared/lib/agent/planning/utils";
import {
  buildCheckpointState,
  parseCheckpoint,
} from "@/shared/lib/agent/memory/checkpoint";
import { prepareRunContext } from "@/shared/lib/agent/execution/context";
import { initializePlanState } from "@/shared/lib/agent/execution/plan";
import { runPlanStepLoop } from "@/shared/lib/agent/execution/step-runner";
import { finalizeAgentRun } from "@/shared/lib/agent/execution/finalize";
