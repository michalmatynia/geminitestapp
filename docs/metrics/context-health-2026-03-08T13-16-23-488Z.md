...
Generated at: 2026-03-08T13:16:23.488Z
...
| context-monolith | 0 | 6 | 0 |
| context-missing-split | 0 | 0 | 26 |
...
| WARN | context-monolith | src/features/kangur/ui/context/KangurGameRuntimeContext.tsx | Context provider value has ~33 fields (threshold: 15). Consider splitting into domain-specific contexts. |
| WARN | context-monolith | src/features/kangur/ui/context/KangurLessonsRuntimeContext.tsx | Context provider value has ~18 fields (threshold: 15). Consider splitting into domain-specific contexts. |
