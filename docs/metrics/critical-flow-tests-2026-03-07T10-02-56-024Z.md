...
Generated at: 2026-03-07T10:02:56.024Z
...
| --- | --- | --- | ---: | ---: | --- |
| Authentication + Session Bootstrap | Successful sign-in completion rate | PASS | 3.4s | 0 | `__tests__/features/auth/pages/signin-page.test.tsx` |
