...
import { pauseFilemakerJobBoardScrapeRun } from '@/features/filemaker/server/filemaker-job-board-scrape-runtime';
...
export async function postHandler(
  ...
  const snapshot = await pauseFilemakerJobBoardScrapeRun(resolveRunId(params));
