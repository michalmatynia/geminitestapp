...
import { useKangurMobileLeaderboardBadges } from './useKangurMobileLeaderboardBadges';

describe('useKangurMobileLeaderboardBadges', () => {
  it('reuses the shared home badge summary for the leaderboard surface', () => {
    ...
    const { result } = renderHook(() => useKangurMobileLeaderboardBadges());
