...
export const MILKBAR_FASTCOMET_BASE_URL = 'https://uploads.milkbardesigners.com';
export const MILKBAR_FASTCOMET_UPLOAD_ENDPOINT = 'https://uploads.milkbardesigners.com/api/uploads/index.php';
export const MILKBAR_FASTCOMET_DELETE_ENDPOINT = 'https://uploads.milkbardesigners.com/api/uploads/delete/index.php';
export const MILKBAR_FASTCOMET_SERVER = 'uploads.milkbardesigners.com';
export const MILKBAR_FASTCOMET_RESOLVE_IP = '209.42.31.54';
