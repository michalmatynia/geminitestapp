...
import { CmsBuilderRootProviders } from '../components/CmsBuilderRootProviders';
      ...
      <body suppressHydrationWarning className={cn('max-w-full overflow-x-hidden font-sans')}>
        ...
        <AppIntlProvider locale={locale} messages={messages}>
          <Suspense fallback={<div className='min-h-screen' aria-busy='true' />}>
            <CmsBuilderRootProviders initialLiteSettings={liteSettingsEntries}>
              {children}
            </CmsBuilderRootProviders>
          </Suspense>
        </AppIntlProvider>
      </body>
    </html>
