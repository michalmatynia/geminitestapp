...
const NODE_TYPE_COMPATIBILITY: Record<NodeType, NodeType[]> = {
  ...
  iterator: ["viewer", "bundle", "template", "prompt", "model", "agent", "delay", "poll", "database", "notification"],
  ...
  model: ["prompt", "database", "viewer", "description_updater", "bundle", "poll", "notification", "agent"],
  agent: ["viewer", "bundle", "template", "prompt", "database", "description_updater", "notification", "delay"],
  viewer: [],
