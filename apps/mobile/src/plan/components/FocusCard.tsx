...
export function FocusCard({
  ...
  return (
    <InsetPanel gap={10}>
      ...
      <FocusCardMetrics accentColor={accentColor} operation={operation} copy={copy} />
      <FocusCardActions copy={copy} historyHref={historyHref} lessonHref={lessonHref} practiceHref={practiceHref} />
    </InsetPanel>
  );
}
