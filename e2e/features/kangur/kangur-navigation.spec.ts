...
const PARENT_DASHBOARD_HEADING_PATTERN = /^(?:Panel Rodzica|Parent dashboard)$/i;
...
const expectLessonsLibraryReady = async (page: Page): Promise<void> => {
...
const ensureVisibleLessonEntry = async (page: Page): Promise<Locator> => {
