...
import type { ProductAiJobUpdate } from "@/features/products/types/services/product-ai-job-repository";
import type { ProductAiJobType } from "@/features/products/types";
