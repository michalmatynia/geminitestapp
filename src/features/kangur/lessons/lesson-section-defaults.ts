  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        sortOrder: 5 * SORT_GAP,
        enabled: true,
        componentIds: ['webdev_js_async'],
      },
      {
        id: 'webdev_js_tooling',
        label: 'Reference & Debugging',
        typeLabel: 'Subsection',
        sortOrder: 6 * SORT_GAP,
        enabled: true,
        componentIds: ['webdev_js_tooling'],
      },
    ],
  },
];
