...
import { matchesImageAsset, mergeImageAssets } from './SocialPublishingPage.Constants';
...
export type ResolvedSocialPostImageState = {
  ...
  latestSelectedAddons: SocialPublishingImageAddon[];
...
const buildRecentAddonMap = (
  recentAddons: SocialPublishingImageAddon[]
): Map<string, SocialPublishingImageAddon> =>
  new Map(
    recentAddons
...
export const resolveSocialPostImageState = ({
  ...
  const latestSelectedAddons: SocialPublishingImageAddon[] = [];
