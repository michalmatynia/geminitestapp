...
Generated at: 2026-03-07T18:10:37.333Z
Node: v24.3.0
...
- Build pass rate: 100%
- Build preflight: removed (Removed .next/standalone before build to reclaim disk space.)
- Lint pass rate: n/a%
...
| Critical Flow Gate | PASS | 21.8s | 0 | `npm run test:critical-flows:strict -- --ci --no-history` |
| Security Smoke Gate | PASS | 8.4s | 0 | `npm run test:security-smoke:strict -- --ci --no-history` |
...
| Observability Check | PASS | 973ms | 0 | `npm run observability:check` |
