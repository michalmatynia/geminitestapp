    ...
    return categories
      ...
      .map((cat: CategoryTreeRecord): CategoryWithChildren => ({
        ...
        notes: cat.notes.map((nc: CategoryTreeRecord['notes'][number]) => ({
          ...
          })) as unknown as NoteWithRelations['tags'],
          ...
          })) as unknown as NoteWithRelations['categories'],
          relationsFrom: [] as unknown as NoteWithRelations['relationsFrom'],
          relationsTo: [] as unknown as NoteWithRelations['relationsTo'],
        })),
