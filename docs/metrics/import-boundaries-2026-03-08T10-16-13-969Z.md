...
Generated at: 2026-03-08T10:16:13.969Z
...
- ai -> jobs -> products -> ai
- products -> product-sync -> integrations -> products
- integrations -> data-import-export -> integrations
- products -> product-sync -> integrations -> data-import-export -> products
- product-sync -> integrations -> product-sync
- ai -> jobs -> ai
...
| products | ai, files, foldertree, internationalization, product-sync, tooltip-engine | 6 |
...
| ERROR | circular-feature-dep | - | Circular dependency between features: products -> product-sync -> integrations -> products |
| ERROR | circular-feature-dep | - | Circular dependency between features: integrations -> data-import-export -> integrations |
| ERROR | circular-feature-dep | - | Circular dependency between features: products -> product-sync -> integrations -> data-import-export -> products |
| ERROR | circular-feature-dep | - | Circular dependency between features: product-sync -> integrations -> product-sync |
