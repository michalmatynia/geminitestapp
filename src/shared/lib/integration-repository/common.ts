...
export const toConnectionRecord = (doc: unknown): IntegrationConnectionRecord => {
  ...
  return {
    ...
    googleAccessToken: (d['googleAccessToken'] as string) ?? null,
    googleRefreshToken: (d['googleRefreshToken'] as string) ?? null,
    googleTokenType: (d['googleTokenType'] as string) ?? null,
    googleScope: (d['googleScope'] as string) ?? null,
    googleExpiresAt: toIsoStringOrNull(d['googleExpiresAt']),
    googleTokenUpdatedAt: toIsoStringOrNull(d['googleTokenUpdatedAt']),
