...
describe('useKangurMobileResultsBadges', () => {
  it('reuses the shared home badge summary for the results surface', () => {
    ...
    const { result } = renderHook(() => useKangurMobileResultsBadges());
