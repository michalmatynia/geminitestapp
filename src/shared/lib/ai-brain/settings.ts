...
export const BRAIN_CAPABILITY_REGISTRY: Record<AiBrainCapabilityKey, BrainCapabilityDefinition> = {
  ...
  'kangur_social.post_generation': {
    key: 'kangur_social.post_generation',
    feature: 'kangur_social',
    label: 'Kangur Social Post Generation',
    policy: 'model-only',
    modelFamily: 'chat',
  },
  'kangur_social.visual_analysis': {
    key: 'kangur_social.visual_analysis',
    feature: 'kangur_social',
    label: 'Kangur Social Visual Analysis',
    policy: 'model-only',
    modelFamily: 'vision_extract',
  },
  ...
  'product.scan.amazon_candidate_match': {
    ...
    feature: 'products',
    label: 'Amazon Scan Candidate Match',
    policy: 'model-only',
    modelFamily: 'vision_extract',
  },
  'product.translation': {
...
export const DEFAULT_BRAIN_CAPABILITY_BY_FEATURE: Record<AiBrainFeature, AiBrainCapabilityKey> = {
  ...
  kangur_social: 'kangur_social.post_generation',
