  ...
  intro: [
    {
      ...
      content: (
        <div className='flex flex-col items-center gap-4'>
          ...
          <div className='bg-pink-50 border border-pink-200 rounded-2xl p-4 w-full text-sm'>
            ...
            <div className='mt-2 bg-white rounded-xl p-2 border border-pink-100 text-center'>
        ...
        <div className='flex flex-col items-center gap-4'>
          ...
          <div className='flex flex-col gap-2 w-full'>
            {[
              ...
              <div key={pair} className='bg-pink-50 border border-pink-200 rounded-2xl p-3 text-sm'>
        ...
        <div className='flex flex-col items-center gap-4'>
          ...
          <div className='flex flex-col gap-2 w-full'>
            {[
              ...
              <div key={pair} className='bg-rose-50 border border-rose-200 rounded-2xl p-3 text-sm'>
        ...
        <div className='flex flex-col items-center gap-4'>
          ...
          <div className='flex flex-col gap-3 w-full'>
            {[
              ...
              <div key={rule} className='bg-pink-50 border border-pink-200 rounded-2xl p-3 text-center'>
