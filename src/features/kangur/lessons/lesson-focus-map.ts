...
export const FOCUS_TO_COMPONENT: Record<string, KangurLessonComponentId> = {
  ...
  javascript: 'webdev_js_basics',
  js: 'webdev_js_basics',
  javascript_basics: 'webdev_js_basics',
  'javascript-basics': 'webdev_js_basics',
  js_basics: 'webdev_js_basics',
  'js-basics': 'webdev_js_basics',
  first_steps: 'webdev_js_basics',
  'first-steps': 'webdev_js_basics',
  webdev_js_basics: 'webdev_js_basics',
  javascript_syntax: 'webdev_js_syntax',
  'javascript-syntax': 'webdev_js_syntax',
  js_syntax: 'webdev_js_syntax',
  'js-syntax': 'webdev_js_syntax',
  syntax_types: 'webdev_js_syntax',
  'syntax-types': 'webdev_js_syntax',
  webdev_js_syntax: 'webdev_js_syntax',
  javascript_dom: 'webdev_js_dom',
  'javascript-dom': 'webdev_js_dom',
  js_dom: 'webdev_js_dom',
  'js-dom': 'webdev_js_dom',
  browser_apis: 'webdev_js_dom',
  'browser-apis': 'webdev_js_dom',
  webdev_js_dom: 'webdev_js_dom',
  javascript_modules: 'webdev_js_es6',
  'javascript-modules': 'webdev_js_es6',
  js_modules: 'webdev_js_es6',
  'js-modules': 'webdev_js_es6',
  functions_objects_modules: 'webdev_js_es6',
  'functions-objects-modules': 'webdev_js_es6',
  webdev_js_es6: 'webdev_js_es6',
  javascript_async: 'webdev_js_async',
  'javascript-async': 'webdev_js_async',
  js_async: 'webdev_js_async',
  'js-async': 'webdev_js_async',
  async_javascript: 'webdev_js_async',
  'async-javascript': 'webdev_js_async',
  webdev_js_async: 'webdev_js_async',
  javascript_reference: 'webdev_js_tooling',
  'javascript-reference': 'webdev_js_tooling',
  js_reference: 'webdev_js_tooling',
  'js-reference': 'webdev_js_tooling',
  debugging: 'webdev_js_tooling',
  reference_debugging: 'webdev_js_tooling',
  'reference-debugging': 'webdev_js_tooling',
