...
import { persistCheckpoint } from "@/features/agent-runtime/memory/checkpoint";
import type { PlanHierarchy } from "@/features/agent-runtime/planning/utils";

type CheckpointState = ReturnType<
  typeof import("@/features/agent-runtime/memory/checkpoint").parseCheckpoint
>;
