    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
        <div style={{
          ...
          <div className="type-label" style={{ color: 'var(--muted)' }}>Registered users</div>
        </div>
      </div>
      ...
      <div style={{ borderTop: '1px solid rgba(210,116,102,0.2)' }}>
        ...
        {loading && (
          <div className="type-label" style={{ color: 'var(--muted)', padding: '1rem 0' }}>Loading…</div>
        )}
        {error && (
          <div className="type-label" style={{ color: 'var(--coral-red)', padding: '1rem 0' }}>{error}</div>
        )}
        {!loading && !error && adminUsers.length === 0 && (
          <div className="type-label" style={{ color: 'var(--muted)', padding: '1rem 0' }}>No users found.</div>
        )}
        {!loading && !error && adminUsers.length > 0 && (
...
export default function AccountPage(): JSX.Element {
  ...
  const tabs: { id: Tab; label: string }[] = [
    ...
    ...(user?.isSuperAdmin ? [{ id: 'admin' as Tab, label: 'Admin' }] : []),
  ];
    ...
    return (
      <>
        ...
        <main style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="type-label" style={{ color: 'var(--muted)', letterSpacing: '0.2em' }}>Loading…</div>
        </main>
        <SiteFooter />
      </>
    );
        ...
        <main style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
          <div style={{
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.9rem', fontWeight: 300, color: 'var(--muted-teal)', marginBottom: '2rem', lineHeight: 1.7 }}>
              Sign in to view your orders, saved items, and account settings.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <a href="/" className="btn-ghost" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
                Back to shop
              </a>
            </div>
          </div>
      ...
      <main style={{ paddingTop: 'var(--nav-h)', minHeight: '100vh' }}>
        ...
        >
          ...
          <div className="relative z-10 max-w-screen-2xl mx-auto">
            <div className="type-label mb-3" style={{ color: 'var(--accent)' }}>Member</div>
            <h1 className="type-display-lg" style={{ color: 'var(--fg)' }}>
              Welcome back, {user.name.split(' ')[0]}
            </h1>
            <p className="type-label mt-2" style={{ color: 'var(--muted)' }}>
              {user.isSuperAdmin ? 'Super Admin · ' : ''}{MOCK_ORDERS.length} orders
            </p>
          </div>
        </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-8 md:px-16 py-12">
          <div className="flex flex-col md:flex-row gap-10 md:gap-16">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    {[
                      ...
                      { label: 'Items purchased', value: '5' },
                      { label: 'Wishlist', value: wishlistCount.toString() },
                      { label: 'Member since', value: 'Member' },
                    ].map((stat) => (
                      <div
                        key={stat.label}
                        className="px-6 py-8"
                  ...
                  <div className="mb-6">
                    <div className="type-label mb-6" style={{ color: 'var(--accent)' }}>Most recent order</div>
                    <div style={{ border: '1px solid var(--border)' }}>
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          >
                            {STATUS_LABELS[MOCK_ORDERS[0].status].label}
                          </div>
              ...
              {activeTab === 'settings' && (
                <div>
                  ...
                  <div className="flex flex-col gap-8">
                    <div>
                      <div className="type-label mb-5" style={{ color: 'var(--accent)' }}>Personal details</div>
                    ...
                    <div>
                      <div className="type-label mb-5" style={{ color: 'var(--accent)' }}>Default shipping address</div>
                      <div
                    ...
                    <div>
                      <div className="type-label mb-5" style={{ color: 'var(--accent)' }}>Communication preferences</div>
              ...
              {/* Admin tab */}
              {activeTab === 'admin' && user.isSuperAdmin && <AdminTab />}
